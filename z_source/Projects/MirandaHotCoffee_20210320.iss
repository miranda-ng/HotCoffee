...
Type: files; Name: {app}\Skins\Avatars\MRA.png; Components: not Protocols\MRA; Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\Skins\Avatars\MSN.png; Components: not Protocols\MSN; Check: IsPortableSetupType and IsUpdate;
...
;Type: files; Name: {app}\Skins\Avatars\MSN.png; Check: IsPortableSetupType and IsUpdate;
 ; Protocols\Skype
...
Type: files; Name: {app}\Skins\Sounds\call_in.wav; Components: not Protocols\Skype; Check: IsPortableSetupType and IsUpdate;
 ; Protocols\Tox
Type: files; Name: {app}\Libs\libtox.dll; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\libtox.dll; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\Plugins\Tox.dll; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\Plugins\Tox.ini; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\Icons\Proto_conn_Tox.dll; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\Icons\Proto_Tox.dll; Components: not Protocols\Tox; Check: IsPortableSetupType and IsUpdate;
 ; Protocols\Twitter
...
Type: files; Name: {app}\Plugins\BuddyExpectator.dll; Components: not Plugins\BuddyExpectator; Check: IsPortableSetupType and IsUpdate;
 ; Plugins\ChangeKeyboardLayout
Type: files; Name: {app}\Plugins\ChangeKeyboardLayout.dll; Components: not Plugins\ChangeKeyboardLayout; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\Plugins\TranslitSwitcher.dll; Components: not Plugins\ChangeKeyboardLayout; Check: IsPortableSetupType and IsUpdate;
 ; Plugins\DbEditorPP
...
Type: files; Name: {app}\Skins\Sounds\Nudge.wav; Components: not ({#JabberProtocols} and Protocols\MRA and Protocols\MSN); Check: IsPortableSetupType and IsUpdate;
...
;Source: x86\Skins\Avatars\MRA.png; DestDir: {app}\Skins\Avatars; Flags: ignoreversion; Components: Protocols\MRA; AfterInstall: AddDetails;
 ; Protocols\MSN
...
;Source: x86\Skins\Avatars\MSN.png; DestDir: {app}\Skins\Avatars; Flags: ignoreversion; Components: Protocols\MSN; AfterInstall: AddDetails;
 ; Protocols\Skype
...
Source: x86\Skins\Sounds\call_in.wav; DestDir: {app}\Skins\Sounds; Flags: ignoreversion; Components: Protocols\Skype; AfterInstall: AddDetails;
 ; Protocols\Tox
;Source: {#AppArch}\Libs\libtox.dll; DestDir: {app}\Libs; Flags: ignoreversion; Components: Protocols\Tox; AfterInstall: AddDetails;
Source: {#AppArch}\Plugins\Tox.dll; DestDir: {app}\Plugins; Flags: ignoreversion; Components: Protocols\Tox; AfterInstall: AddDetails;
;Source: x86\Plugins\Tox.ini; DestDir: {app}\Plugins; Flags: ignoreversion; Components: Protocols\Tox; AfterInstall: AddDetails;
...
Source: x86\Plugins\mRadio\mRadio.ini; DestDir: {app}\Plugins\mRadio; Flags: ignoreversion; Components: Protocols\other\mRadio; AfterInstall: AddDetails;
Source: x86\Plugins\mRadio\player.ini; DestDir: {app}\Plugins\mRadio; Flags: ignoreversion; Components: Protocols\other\mRadio; AfterInstall: AddDetails;
...
Source: x86\Plugins\CurrencyRates\*; DestDir: {app}\Plugins\CurrencyRates; Flags: ignoreversion; Components: Protocols\other\CurrencyRates; AfterInstall: AddDetails;
...
Source: x86\Skins\Sounds\Nudge.wav; DestDir: {app}\Skins\Sounds; Flags: ignoreversion; Components: {#JabberProtocol} or Protocols\MRA or Protocols\MSN; AfterInstall: AddDetails;
 ; Plugins\QuickMessages
...
;Source: {#AppArch}\Plugins\mTextControl.dll; DestDir: {app}\Plugins; Flags: ignoreversion; Components: Resources\PopupPlus; AfterInstall: AddDetails;
 ; Resources\Smileys
...
Source: x86\Skins\SplashScreen\HotSplash0.png; DestDir: {app}\Skins\SplashScreen; Flags: ignoreversion; Components: Resources\SplashScreen; AfterInstall: AddDetails;
Source: x86\Skins\SplashScreen\HotSplash1.png; DestDir: {app}\Skins\SplashScreen; Flags: ignoreversion; Components: Resources\SplashScreen; AfterInstall: AddDetails;
Source: x86\Skins\SplashScreen\HotSplash2.png; DestDir: {app}\Skins\SplashScreen; Flags: ignoreversion; Components: Resources\SplashScreen; AfterInstall: AddDetails;
Source: x86\Skins\SplashScreen\HotSplash3.png; DestDir: {app}\Skins\SplashScreen; Flags: ignoreversion; Components: Resources\SplashScreen; AfterInstall: AddDetails;
Source: x86\Skins\SplashScreen\HotSplash4.png; DestDir: {app}\Skins\SplashScreen; Flags: ignoreversion; Components: Resources\SplashScreen; AfterInstall: AddDetails;
...
Name: Protocols\Tox; Description: {code:ComponentsHelper|ProtocolsTox}; Types: custom; Flags: dontinheritcheck disablenouninstallwarning;
...
Name: Plugins\Flags; Description: {code:ComponentsHelper|Flags}; Types: custom; Flags: dontinheritcheck disablenouninstallwarning;
...
Name: Protocols\Tox; Description: {code:ComponentsHelper|ProtocolsTox}; Types: full custom; Flags: disablenouninstallwarning;
...
Name: Plugins\Flags; Description: {code:ComponentsHelper|Flags}; Types: full custom; Flags: disablenouninstallwarning;
...
Filename: {app}\Profiles\settings.ini; Section: Protocols; Key: 78; String: sTOX; Flags: uninsdeleteentry; Components: Protocols\Tox;
Filename: {app}\Profiles\settings.ini; Section: Protocols; Key: 278; String: d78; Flags: uninsdeleteentry; Components: Protocols\Tox;
...
//        Result := Format('%d', [4 * (n + (5 - (n mod 5)) mod 5) + 1]);
    ...
    // 沫桯ᱠ홇���馠GetCLUIFrames 񡣥럅qualSections, ...
    // 󬡢 衢鲨󦡮𡸨򬞠𐱮󯫮쯢 n ...
    // 񦨳콲ᳮ꡴������馠ⴤ氠'1' (ﰠ1 嬠5 𐱮󯫮쯢)...
    // 鮠���0' (6 鬨 7 𐱮󯫮쯢)
    case Param of
