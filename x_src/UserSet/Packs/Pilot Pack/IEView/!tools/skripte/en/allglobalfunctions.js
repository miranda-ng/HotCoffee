...
function openPictureArea(ids){
    ...
    idname = ids.split('[trenn]')[2];
    newAusgabe = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                +'<img src="'+imagespfad+'/arrow_turn_left.png" class="icons" onmouseover="src=\''+imagespfad+'/arrow_turn_left_d.png\';" onmouseout="src=\''+imagespfad+'/arrow_turn_left.png\'" onmousedown="getElementById(\''+idname+'i\').style.filter=\'progid:DXImageTransform.Microsoft.BasicImage(grayscale=0, xray=0, mirror=0, invert=0, opacity=1, rotation=3);\'" title="Turn left">'
                +'<img src="'+imagespfad+'/arrow_up.png" class="icons" onmouseover="src=\''+imagespfad+'/arrow_up_d.png\';" onmouseout="src=\''+imagespfad+'/arrow_up.png\'" onmousedown="getElementById(\''+idname+'i\').style.filter=\'progid:DXImageTransform.Microsoft.BasicImage(grayscale=0, xray=0, mirror=0, invert=0, opacity=1, rotation=4)\'" title="Standard orientation">'
                +'<img src="'+imagespfad+'/arrow_turn_right.png" class="icons" onmouseover="src=\''+imagespfad+'/arrow_turn_right_d.png\';" onmouseout="src=\''+imagespfad+'/arrow_turn_right.png\'" onmousedown="getElementById(\''+idname+'i\').style.filter=\'progid:DXImageTransform.Microsoft.BasicImage(grayscale=0, xray=0, mirror=0, invert=0, opacity=1, rotation=1)\'" title="Turn right">&nbsp;&nbsp;&nbsp;';
      //toolbar2
    newAusgabe = newAusgabe +'<img src="'+imagespfad+'/zoom_in.png" class="icons" onmouseover="src=\''+imagespfad+'/zoom_in_d.png\';" onmouseout="src=\''+imagespfad+'/zoom_in.png\'" onmousedown="resize_big(document.getElementById(\''+idname+'i\'))" title="Zoom in">'
                +'<img src="'+imagespfad+'/zoom_out.png" class="icons" onmouseover="src=\''+imagespfad+'/zoom_out_d.png\';" onmouseout="src=\''+imagespfad+'/zoom_out.png\'" onmousedown="resize_small(document.getElementById(\''+idname+'i\'))" title="Zoom out"><br>';
...
function swfarea(swfflash,ids) { 
  ...
  if (swfflash.innerHTML!="") {
    ...
    swfbereich.display = 'none';
      ...
      //toolbar2
    ausgabe = '<img src="'+imagespfad+'zoom_in.png" class="icons" onmouseover="src=\''+imagespfad+'zoom_in_d.png\';" onmouseout="src=\''+imagespfad+'zoom_in.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'swf\'),\'vergroessern\')" title="Zoom in">'
             +'<img src="'+imagespfad+'zoom_out.png" class="icons" onmouseover="src=\''+imagespfad+'zoom_out_d.png\';" onmouseout="src=\''+imagespfad+'zoom_out.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'swf\'),\'verkleinern\')" title="Zoom out">&nbsp;&nbsp;&nbsp;';
      //toolbar3
    ausgabe = ausgabe+'<img src="'+imagespfad+'breiter.png" class="icons" onmouseover="src=\''+imagespfad+'breiter_d.png\';" onmouseout="src=\''+imagespfad+'breiter.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'swf\'),\'seitenverhaeltnisgroesser\')" title="Decrease towards">'
                     +'<img src="'+imagespfad+'reset.png" class="icons" onmouseover="src=\''+imagespfad+'/reset_d.png\';" onmouseout="src=\''+imagespfad+'/reset.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'swf\'),\'seitenverhaeltnisreset\')" title="Reset">'
                     +'<img src="'+imagespfad+'schmaler.png" class="icons" onmouseover="src=\''+imagespfad+'/schmaler_d.png\';" onmouseout="src=\''+imagespfad+'/schmaler.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'swf\'),\'seitenverhaeltniskleiner\')" title="Increase toward"><br>';
...
function videoarea(videos,ids,popup) {
  ...
  if (popup == 1) {
    ...
    if (videos.innerHTML!="") {
      ...
      if (videostring!=0) {
          //toolbar2
        ausgabe = '<img src="'+imagespfad+'/zoom_in.png" class="icons" onmouseover="src=\''+imagespfad+'/zoom_in_d.png\';" onmouseout="src=\''+imagespfad+'/zoom_in.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'video\'),\'vergroessern\')" title="Zoom in">'
                 +'<img src="'+imagespfad+'/zoom_out.png" class="icons" onmouseover="src=\''+imagespfad+'/zoom_out_d.png\';" onmouseout="src=\''+imagespfad+'/zoom_out.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'video\'),\'verkleinern\')" title="Zoom out">&nbsp;&nbsp;&nbsp;';
          //toolbar3
        ausgabe = ausgabe+'<img src="'+imagespfad+'/breiter.png" class="icons" onmouseover="src=\''+imagespfad+'/breiter_d.png\';" onmouseout="src=\''+imagespfad+'/breiter.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'video\'),\'seitenverhaeltnisgroesser\')" title="Decrease towards">'
                         +'<img src="'+imagespfad+'/reset.png" class="icons" onmouseover="src=\''+imagespfad+'/reset_d.png\';" onmouseout="src=\''+imagespfad+'/reset.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'video\'),\'seitenverhaeltnisreset\')" title="Reset">'
                         +'<img src="'+imagespfad+'/schmaler.png" class="icons" onmouseover="src=\''+imagespfad+'/schmaler_d.png\';" onmouseout="src=\''+imagespfad+'/schmaler.png\'" onmousedown="resize_animation(document.getElementById(\''+idname+'video\'),\'seitenverhaeltniskleiner\')" title="Increase toward"><br>';
