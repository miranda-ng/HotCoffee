...
#define AppVerBuild "4"
#define AppVerRevis "13028"
#define AppVerStatusBuild " alpha build #"
#define AppStatus "Final R2"
...
#define AppUpdateVersion "0.95.1.8060,0.95.3.11700,0.95.3.11706,0.95.4.12376,0.95.4.13028" ; product version update range
...
#define SelectedSettingsDefault \
    "UpdateSettings,StableVersion,ContactList,CompactMode,UseSound,CLCNoVScrollBar,SendingMessage," + \
...
Type: files; Name: {app}\skins\myavatars\irc.png; Components: not protocols\irc; Check: IsPortableSetupType and IsUpdate;
 ; protocols\jabber
Type: files; Name: {app}\plugins\jabber.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\plugins\gtalkext.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\plugins\nudge.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\mra and protocols\msn and protocols\yahoo); Check: IsPortableSetupType and IsUpdate;
;Type: files; Name: {app}\plugins\nudge.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\mra and protocols\yahoo); Check: IsPortableSetupType and IsUpdate;
...
;Type: files; Name: {app}\skins\sounds\nudge.wav; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\mra and protocols\yahoo); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\skins\myavatars\jabber.png; Components: not (protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\xmpp); Check: IsPortableSetupType and IsUpdate;
 ; protocols\jabber\fb
...
Type: filesandordirs; Name: {app}\skins\smileys\vkontakte; Components: not protocols\vkontakte; Check: IsPortableSetupType and IsUpdate;
 ; protocols\whatsapp
...
Type: files; Name: {app}\skins\sounds\reminder.wav; Components: not plugins\uinfoex; Check: IsPortableSetupType and IsUpdate;
 ; plugins\watrack
Type: files; Name: {app}\plugins\watrack.dll; Components: not plugins\watrack; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\watrack_buttons.dll; Components: not plugins\watrack; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\watrack_icons.dll; Components: not plugins\watrack; Check: IsPortableSetupType and IsUpdate;
 ; plugins\birthday
...
Type: filesandordirs; Name: {app}\skins\ieview; Components: not resources\ieview; Check: IsPortableSetupType and IsUpdate;
 ; IEViewAnimation
Type: files; Name: {app}\skins\ieview\!tools\skripte\animation0.js; Check: IsStyleChecked('IEViewAnimation') and IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\skins\ieview\!tools\skripte\animation1.js; Check: not IsStyleChecked('IEViewAnimation') and IsPortableSetupType and IsUpdate;
 ; IEViewAvatar
Type: files; Name: {app}\skins\ieview\noavatar.png; Check: not IsStyleChecked('IEViewAvatar') and IsPortableSetupType and IsUpdate;
 ; handwritting font
Type: files; Name: {app}\skins\ieview\styles\handwritting.css; Check: not IsStyleChecked('FontHandwritting') and IsPortableSetupType and IsUpdate;
 ; printing font
Type: files; Name: {app}\skins\ieview\styles\printing.css; Check: not IsStyleChecked('FontPrinting') and IsPortableSetupType and IsUpdate;
 ; resources\popup
...
Source: x86\docs\license_en.html; DestDir: {app}\docs; DestName: license.html; Languages: en; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\docs\license\kolobok_en.html; DestDir: {app}\docs\license; Languages: en; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\docs\license_ru.html; DestDir: {app}\docs; DestName: license.html; Languages: ru; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\docs\license\kolobok_ru.html; DestDir: {app}\docs\license; Languages: ru; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\docs\license\*.png; DestDir: {app}\docs\license; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
;Source: {#AppArch}\plugins\nudge.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp or protocols\mra or protocols\yahoo; AfterInstall: AddDetails;
...
Source: {#AppArch}\plugins\gtalkext.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk; AfterInstall: AddDetails;
 ; protocols\jabber\jabber
...
Source: x86\skins\smileys\vk\*; DestDir: {app}\skins\smileys\vk; Flags: ignoreversion recursesubdirs createallsubdirs; Components: protocols\vkontakte and resources\smileys; AfterInstall: AddDetails;
 ; protocols\whatsapp
...
Source: x86\skins\sounds\reminder.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: plugins\uinfoex and resources\sounds; AfterInstall: AddDetails;
 ; plugins\watrack
Source: {#AppArch}\plugins\watrack.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: plugins\watrack; AfterInstall: AddDetails;
Source: x86\icons\watrack_buttons.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: plugins\watrack; AfterInstall: AddDetails;
Source: x86\icons\watrack_icons.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: plugins\watrack; AfterInstall: AddDetails;
 ; plugins\birthday
...
Source: x86\skins\ieview\!tools\skripte\*; DestDir: {app}\skins\ieview\!tools\skripte; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
...
Source: x86\skins\smileys\flash\*; DestDir: {app}\skins\smileys\flash; Flags: ignoreversion; Components: resources\smileys; AfterInstall: AddDetails;
Source: x86\skins\smileys\_dark\kolobok\*; DestDir: {app}\skins\smileys\_dark\kolobok; Flags: ignoreversion; Components: resources\smileys; AfterInstall: AddDetails;
Source: x86\skins\smileys\_light\kolobok\*; DestDir: {app}\skins\smileys\_light\kolobok; Flags: ignoreversion; Components: resources\smileys; AfterInstall: AddDetails;
Source: x86\skins\smileys\emoji\*; DestDir: {app}\skins\smileys\emoji; Flags: ignoreversion recursesubdirs createallsubdirs; Components: resources\smileys; AfterInstall: AddDetails;
 ; resources\smileys\big
Source: x86\skins\smileys\_dark\kolobok\kolobok_big.msl; DestDir: {app}\skins\smileys\_dark\kolobok; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\big; AfterInstall: AddDetails;
Source: x86\skins\smileys\_light\kolobok\kolobok_big.msl; DestDir: {app}\skins\smileys\_light\kolobok; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\big; AfterInstall: AddDetails;
 ; resources\smileys\small
Source: x86\skins\smileys\_dark\kolobok\kolobok_small.msl; DestDir: {app}\skins\smileys\_dark\kolobok; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\small; AfterInstall: AddDetails;
Source: x86\skins\smileys\_light\kolobok\kolobok_small.msl; DestDir: {app}\skins\smileys\_light\kolobok; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\small; AfterInstall: AddDetails;
 ; resources\smileys\big
Source: x86\skins\smileys\emoji\emoji_big.msl; DestDir: {app}\skins\smileys\emoji; DestName: emoji.msl; Flags: ignoreversion; Components: resources\smileys\big; AfterInstall: AddDetails;
 ; resources\smileys\small
Source: x86\skins\smileys\emoji\emoji_small.msl; DestDir: {app}\skins\smileys\emoji; DestName: emoji.msl; Flags: ignoreversion; Components: resources\smileys\small; AfterInstall: AddDetails;
 ; resources\sounds
...
Source: x86\skins\ieview\!tools\other\avatar0\{#theme[i]}.ivt; DestDir: {app}\skins\ieview\!tools\other\avatar0; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar1\{#theme[i]}.ivt; DestDir: {app}\skins\ieview\!tools\other\avatar1; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; AfterInstall: AddDetails;
 ; IEViewAnimation off
Source: x86\skins\ieview\!tools\other\animation0\*; DestDir: {app}\skins\ieview\!tools\other\animation0; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\animation0\*; DestDir: {app}\skins\ieview\!tools\skripte; Flags: ignoreversion; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation'); AfterInstall: AddDetails;
 ; IEViewAnimation on
Source: x86\skins\ieview\!tools\other\animation1\*; DestDir: {app}\skins\ieview\!tools\other\animation1; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\animation1\*; DestDir: {app}\skins\ieview\!tools\skripte; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation'); AfterInstall: AddDetails;
 ; IEViewAvatar off
Source: x86\skins\ieview\!tools\other\avatar0\defaultwinl.ivt; DestDir: {app}\skins\ieview\!tools\other\avatar0; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar0\defaultwinl.ivt; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: not IsStyleChecked('IEViewAvatar'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar0\{#theme[i]}.ivt; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; Check: not IsStyleChecked('IEViewAvatar'); AfterInstall: AddDetails;
 ; IEViewAvatar on
Source: x86\skins\ieview\!tools\other\avatar1\defaultwinl.ivt; DestDir: {app}\skins\ieview\!tools\other\avatar1; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar1\noavatar.png; DestDir: {app}\skins\ieview\!tools\other\avatar1; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar1\defaultwinl.ivt; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar1\noavatar.png; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\avatar1\{#theme[i]}.ivt; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; Check: IsStyleChecked('IEViewAvatar'); AfterInstall: AddDetails;
 ; IEViewShortLink off
Source: x86\skins\ieview\!tools\other\shortlink0\config.js; DestDir: {app}\skins\ieview\!tools\other\shortlink0\; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\shortlink0\config.js; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: not IsStyleChecked('IEViewShortLink'); AfterInstall: AddDetails;
 ; IEViewShortLink on
Source: x86\skins\ieview\!tools\other\shortlink1\config.js; DestDir: {app}\skins\ieview\!tools\other\shortlink1\; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\shortlink1\config.js; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink'); AfterInstall: AddDetails;
 ; handwritting font
Source: x86\skins\ieview\!tools\other\handwritting\defaultwinl.css; DestDir: {app}\skins\ieview\!tools\other\handwritting; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\handwritting\handwritting.css; DestDir: {app}\skins\ieview\!tools\other\handwritting; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\handwritting\{#theme[i]}.css; DestDir: {app}\skins\ieview\!tools\other\handwritting; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; AfterInstall: AddDetails;
 ;
Source: x86\skins\ieview\!tools\fonts\handwritting\*; DestDir: {app}\skins\ieview\!tools\fonts; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\handwritting\defaultwinl.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\handwritting\handwritting.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\handwritting\{#theme[i]}.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; Check: IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; printing font
Source: x86\skins\ieview\!tools\other\printing\defaultwinl.css; DestDir: {app}\skins\ieview\!tools\other\printing; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\printing\printing.css; DestDir: {app}\skins\ieview\!tools\other\printing; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\printing\{#theme[i]}.css; DestDir: {app}\skins\ieview\!tools\other\printing; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; AfterInstall: AddDetails;
 ;
Source: x86\skins\ieview\!tools\fonts\printing\*; DestDir: {app}\skins\ieview\!tools\fonts; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\printing\defaultwinl.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\printing\printing.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\other\printing\{#theme[i]}.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\themes\{#theme[i]} and resources\ieview; Check: IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
#endsub
...
Name: plugins\watrack; Description: {code:ComponentsHelper|Watrack}; Types: custom; Flags: dontinheritcheck disablenouninstallwarning;
...
Name: resources\smileys\big; Description: {code:ComponentsHelper|SmileysBig}; Flags: exclusive disablenouninstallwarning;
Name: resources\smileys\small; Description: {code:ComponentsHelper|SmileysSmall}; Types: minimal optimal advanced custom; Flags: exclusive disablenouninstallwarning;
...
Name: plugins\watrack; Description: {code:ComponentsHelper|Watrack}; Types: full custom; Flags: disablenouninstallwarning;
...
Name: resources\smileys\big; Description: {code:ComponentsHelper|SmileysBig}; Flags: exclusive disablenouninstallwarning;
Name: resources\smileys\small; Description: {code:ComponentsHelper|SmileysSmall}; Types: minimal optimal advanced full custom; Flags: exclusive disablenouninstallwarning;
...
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
 ; smileys _light kolobok
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
 ; smileys _dark skype
...
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_dark\skype\skype.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
 ; smileys _light kolobok
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_light\skype\skype.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_light\skype\skype.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_light\skype\skype.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
 ; IEViewAnimation off
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAnimation');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAnimation');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAnimation') and IsUpdate;
 ; IEViewAnimation on
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAnimation');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAnimation');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewAnimation; String: uanimation1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAnimation') and IsUpdate;
 ; IEViewAvatar off
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAvatar');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAvatar');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewAvatar') and IsUpdate;
 ; IEViewAvatar on
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAvatar');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAvatar');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewAvatar; String: uavatar1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewAvatar') and IsUpdate;
 ; IEViewShortLink off
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewShortLink');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewShortLink');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink0; Flags: uninsdeleteentry; Check: not IsStyleChecked('IEViewShortLink') and IsUpdate;
 ; IEViewShortLink on
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewShortLink');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewShortLink');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IEViewShortLink; String: ushortlink1; Flags: uninsdeleteentry; Check: IsStyleChecked('IEViewShortLink') and IsUpdate;
 ; handwritting font
...
Filename: {app}\profiles\autoexec_update.ini; Section: PluginUpdater; Key: UpdateMode; String: b1; Flags: uninsdeleteentry; Check: IsSettingChecked('StableVersion') and IsUpdate;
 ; DontSwitchToStable
Filename: {app}\profiles\settings.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|!StableVersion}; Flags: uninsdeleteentry;
Filename: {app}\profiles\update.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|!StableVersion}; Flags: uninsdeleteentry;
Filename: {app}\profiles\autoexec_update.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|!StableVersion}; Flags: uninsdeleteentry; Check: IsUpdate;
 ; DevelopmentVersion
...
var
    dwResult: DWORD;
begin
    Result := (Pos(Lowercase(ExpandConstant('{pf}')), Lowercase(ExpandConstant('{app}'))) = 1) and
        RegQueryDWordValue(HKLM, 'SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System', 'EnableLUA', dwResult) and
        (dwResult = $1);
end;
...
#if freezecheckbox == 1
        wpFinished:
            WizardForm.RunList.ItemEnabled[3] := False;
#endif
        wpInfoAfter,
        wpFinished:
