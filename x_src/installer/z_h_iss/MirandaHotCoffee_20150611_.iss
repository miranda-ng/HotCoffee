#define debug 1                                                             ; for developers only: 0 - debug off, 1 - debug on
#define splash 0                                                            ; splash screen: 0 - splash off, 1 - splash on
#define aero 3                                                              ; aero theme: 0 - disable, 1 - full, 2 - top, 3 - bottom, 4 - top/bottom.
...
#define AppUpdateVersion "0.95.1.8060,0.95.3.11700,0.95.3.11706,0.95.4.12376" ; product version update range
...
#define SelectedSettingsDefault \
    "UpdateSettings,StableVersion,ContactList,CompactMode,CLCNoVScrollBar,SendingMessage," + \
...
[Languages]
Name: en; MessagesFile: compiler:default.isl,resources\{#AppShortName}_en.isl; LicenseFile: resources\License_en.rtf; InfoBeforeFile: resources\InfoBefore_en.rtf; InfoAfterFile: resources\InfoAfter_en.rtf;
...
Type: files; Name: {app}\icons\proto_conn_skype.dll; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_skype.dll; Check: IsPortableSetupType and IsUpdate;
 ; protocols\tox
...
;Source: x86\skins\myavatars\msn.png; DestDir: {app}\skins\myavatars; Flags: ignoreversion; Components: protocols\msn; AfterInstall: AddDetails;
 ; protocols\skype
;Source: {#AppArch}\plugins\skype.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\skype; OnlyBelowVersion: 0,6.2; AfterInstall: AddDetails;
;Source: x86\plugins\SkypeKit.exe; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\skype; OnlyBelowVersion: 0,6.2; AfterInstall: AddDetails;
;Source: x86\icons\proto_conn_skype.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\skype; OnlyBelowVersion: 0,6.2; AfterInstall: AddDetails;
;Source: x86\icons\proto_skype.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\skype; OnlyBelowVersion: 0,6.2; AfterInstall: AddDetails;
 ; protocols\tox
...
Source: x86\skins\tipper\{#theme[i]}\*; DestDir: {app}\skins\tipper\{#theme[i]}; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist; Components: resources\themes\{#theme[i]} and resources\tipper and resources\smileys; AfterInstall: AddDetails;
...
;Name: protocols\skype; Description: {code:ComponentsHelper|ProtocolsSkype}; Types: minimal optimal advanced custom; Flags: dontinheritcheck disablenouninstallwarning; OnlyBelowVersion: 0,6.2;
...
;Name: protocols\skype; Description: {code:ComponentsHelper|ProtocolsSkype}; Types: minimal optimal advanced full custom; Flags: disablenouninstallwarning; OnlyBelowVersion: 0,6.2;
...
[Tasks]
Name: curuser; Description: {code:TasksHelper|OnlyForTheCurrentUser}; GroupDescription: {cm:CreateShortcut}; Flags: exclusive
...
Name: desktopicon; Description: {code:TasksHelper|CreateDesktopIcon}; GroupDescription: {cm:AdditionalIcons}
...
Filename: {cm:AppURLMNG}; Description: {cm:AppURLMNGOpen}; Flags: nowait postinstall skipifsilent shellexec unchecked;
...
Filename: {app}\profiles\autoexec_update.ini; Section: OK; Key: AM_BaseProto; String: sJABBER; Flags: uninsdeleteentry; Components: protocols\jabber\ok; Check: IsUpdate;
 ; protocols\skype
;Filename: {app}\profiles\settings.ini; Section: Skype; Key: AM_BaseProto; String: sSKYPE; Flags: uninsdeleteentry; Components: protocols\skype; OnlyBelowVersion: 0,6.2;
;Filename: {app}\profiles\settings.ini; Section: Protocols; Key: 75; String: sSkype; Flags: uninsdeleteentry; Components: protocols\skype; OnlyBelowVersion: 0,6.2;
...
;Filename: {app}\profiles\update.ini; Section: Skype; Key: AM_BaseProto; String: sSKYPE; Flags: uninsdeleteentry; Components: protocols\skype; OnlyBelowVersion: 0,6.2;
;Filename: {app}\profiles\autoexec_update.ini; Section: Skype; Key: AM_BaseProto; String: sSKYPE; Flags: uninsdeleteentry; Components: protocols\skype; OnlyBelowVersion: 0,6.2; Check: IsUpdate;
 ; protocols\tox
