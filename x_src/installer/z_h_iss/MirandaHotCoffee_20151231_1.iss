...
[Languages]
Name: en; MessagesFile: resources\english.isl,resources\{#AppShortName}_en.isl; LicenseFile: resources\License_en.rtf; InfoBeforeFile: resources\InfoBefore_en.rtf; InfoAfterFile: resources\{#if AppStatus != "Test"}InfoAfter_en{#else}Test_InfoAfter_en{#endif}.rtf;
Name: ru; MessagesFile: resources\russian.isl,resources\{#AppShortName}_ru.isl; LicenseFile: resources\License_ru.rtf; InfoBeforeFile: resources\InfoBefore_ru.rtf; InfoAfterFile: resources\{#if AppStatus != "Test"}InfoAfter_ru{#else}Test_InfoAfter_ru{#endif}.rtf;
...
Source: x86\scripts\*; DestDir: {app}\scripts; Flags: ignoreversion recursesubdirs createallsubdirs; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\skins\ieview\styles\handwriting.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
...
[Run]
; patcher
Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=fugue_hc /SILENT"; Flags: runhidden; Check: IsStyleChecked('IconsFugue')
Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=nova_hc /SILENT"; Flags: runhidden; Check: IsStyleChecked('IconsNova')
;Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=xpk_hc /SILENT"; Flags: runhidden; Check: IsStyleChecked('IconsXpk')
; postinstall
...
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink on + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation off + IEViewAvatar on + IEViewShortLink off + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink on + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar on + IEViewShortLink off + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar on + IEViewShortLink on + printing font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""printing""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting') and IsUpdate;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink off + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink on + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation off + IEViewAvatar on + IEViewShortLink off + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":false,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink on + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":false},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar on + IEViewShortLink off + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":false,""localy"":false},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting') and IsUpdate;
 ; IEViewAnimation on + IEViewAvatar on + IEViewShortLink on + handwriting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IETemplateConfig; String: "u{{""animation"":{{""enable"":true,""on_window_open"":false},""avatars"":{{""enable"":true},""files"":{{""inbox"":""/inbox/""},""font"":{{""change_size_button"":1,""name"":""handwriting""},""media"":{{""enable"":1,""images_preview"":1,""inline_images"":{{""maxheight"":200,""maxwidth"":300},""video"":{{""external_window"":{{""enable"":0,""height"":600,""width"":800}}},""shortlink"":{{""global"":true,""localy"":true},""tooltipify"":{{""animationDuration"":150,""animationOffset"":0,""animationProperty"":""top"",""displayAware"":1,""opacity"":1,""position"":""bottom""},""tZers"":{{""autoplay"":0,""enable"":1,""only_supported_protos"":0},""version"":""2.1.2""}"; Flags: uninsdeleteentry; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwriting') and IsUpdate;
...
Filename: {app}\profiles\autoexec_update.ini; Section: PluginUpdater; Key: UpdateOnStartup; String: b{code:SetBoolSetting|CheckUpdates}; Flags: uninsdeleteentry; Check: IsUpdate;
 ; StableVersion
#if AppStatus != "Test" && AppStatus != "Alpha R1"
  ...
  try
    ...
    try
      ...
      begin
        colVerbs := objShell.Namespace(ExtractFileDir(szFilename)).ParseName(ExtractFileName(szFilename)).Verbs;
        for i := 1 to colVerbs.Count do
          if CompareText(colVerbs.Item[i].Name, szVerb) = 0 then
          begin
            colVerbs.Item[i].DoIt;
            Result := True;
            Break;
