...
Type: filesandordirs; Name: {app}\skins\ieview\!tools\tZersFiles\mailru; Components: not protocols\mra; Check: IsPortableSetupType and IsUpdate;
...
Type: filesandordirs; Name: {app}\skins\smileys\skype; Components: not protocols\skype; Check: IsPortableSetupType and IsUpdate;
;Type: files; Name: {app}\skins\sounds\disconnect.wav; Components: not protocols\skype; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\skins\sounds\incomingcall.wav; Components: not protocols\skype; Check: IsPortableSetupType and IsUpdate;
 ; protocols\tox
...
Source: x86\skins\ieview\!tools\tZersFiles\mailru\*; DestDir: {app}\skins\ieview\!tools\tZersFiles\mailru; Flags: ignoreversion; Components: protocols\mra and resources\ieview; AfterInstall: AddDetails;
...
Source: x86\skins\smileys\skype\*; DestDir: {app}\skins\smileys\skype; Flags: ignoreversion recursesubdirs createallsubdirs; Components: protocols\skype and resources\smileys; AfterInstall: AddDetails;
...
Source: x86\skins\sounds\incomingcall.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: protocols\skype; AfterInstall: AddDetails;
 ; protocols\tox
...
Source: x86\skins\smileys\dark_skin\*; DestDir: {app}\skins\smileys\dark_skin; Flags: ignoreversion; Components: resources\smileys; AfterInstall: AddDetails;
Source: x86\skins\smileys\light_skin\*; DestDir: {app}\skins\smileys\light_skin; Flags: ignoreversion; Components: resources\smileys; AfterInstall: AddDetails;
 ; resources\smileys\big
Source: x86\skins\smileys\dark_skin\kolobok_big.msl; DestDir: {app}\skins\smileys\dark_skin; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\big; AfterInstall: AddDetails;
Source: x86\skins\smileys\light_skin\kolobok_big.msl; DestDir: {app}\skins\smileys\light_skin; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\big; AfterInstall: AddDetails;
 ; resources\smileys\small
Source: x86\skins\smileys\dark_skin\kolobok_small.msl; DestDir: {app}\skins\smileys\dark_skin; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\small; AfterInstall: AddDetails;
Source: x86\skins\smileys\light_skin\kolobok_small.msl; DestDir: {app}\skins\smileys\light_skin; DestName: kolobok.msl; Flags: ignoreversion; Components: resources\smileys\small; AfterInstall: AddDetails;
 ; resources\sounds
...
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: Skin; String: uwinstylel; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinWinstyleLight') and IsUpdate;
 ; smileys dark_skin
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\dark_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\dark_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\dark_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
...
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\dark_skin\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
 ; smileys light_skin
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\light_skin\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
 ; IEViewAnimation off
...
var
    dwDrives, dwLength, dwBufferLength, dwHandles, dwObjectTypeLength, dwObjectNameLength: DWORD;
...
/////////////////// ////////////////////////////////////////
procedure UninstallPortableFiles(const szFilesList: String);
var
    i: Integer;
begin
    with TStringList.Create do
    try
        CommaText := szFilesList;
        for i := 0 to Count - 1 do
        ...
        ssInstall:
            begin
                ...
                begin
                    ...
                    UninstallPortableFiles(ExpandConstant('{ini:{app}\profiles\{#AppINI},{#AppNameSetup},UninstallFiles|}'));
                end;
