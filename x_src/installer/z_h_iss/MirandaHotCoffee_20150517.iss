...
Source: {#AppArch}\mir_core.dll; DestDir: {app}; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: {#AppArch}\pcre16.dll; DestDir: {app}; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: {#AppArch}\zlib.dll; DestDir: {app}; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\skins\sounds\call_in.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: protocols\skype; AfterInstall: AddDetails;
 ; protocols\tox
Source: {#AppArch}\libtox.dll; DestDir: {app}; Flags: ignoreversion; Components: protocols\tox; AfterInstall: AddDetails;
