...
begin
	...
	Result := Format('u{"animation":{"enable":%s,"on_window_open":false},"avatars":{"enable":%s},"files":{"inbox":"/inbox/"},"font":{"change_size_button":1,"name":"%s"},"media":{"enable":1,"images_preview":1,"inline_images":{"maxheight":200,"maxwidth":300},"video":{"external_window":{"enable":0,"height":600,"width":800}}},"shortlink":{"global":%s,"localy":%s},"tooltipify":{"animationDuration":150,"animationOffset":0,"animationProperty":"top","displayAware":1,"opacity":1,"position":"bottom"},"tZers":{"autoplay":0,"enable":1,"only_supported_protos":0},"version":"2.1.3"}', [BoolToStr(IsStyleChecked('IEViewAnimation')), BoolToStr(IsStyleChecked('IEViewAvatar')), Font, BoolToStr(IsStyleChecked('IEViewShortLink')), BoolToStr(IsStyleChecked('IEViewShortLink'))]);
end;