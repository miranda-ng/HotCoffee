...
#define JabberProtocols "protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex"
...
#define JabberProtocol "protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\hangouts or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp or protocols\jabber\yandex"
...
Filename: {app}\profiles\autoexec_update.ini; Section: IEView_Template; Key: CustomContextMenu; String: b1; Flags: uninsdeleteentry;  Components: resources\ieview; Check: IsStyleChecked('IEViewContextMenu') and IsUpdate;
 ...
 ; IEViewAnimation
;Filename: {app}\profiles\settings.ini; Section: IEView_Template; Key: Animation; String: b{code:SetBoolSetting|IEViewAnimation}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\update.ini; Section: IEView_Template; Key: Animation; String: b{code:SetBoolSetting|IEViewAnimation}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\autoexec_update.ini; Section: IEView_Template; Key: Animation; String: b{code:SetBoolSetting|IEViewAnimation}; Flags: uninsdeleteentry;  Components: resources\ieview; Check: IsUpdate;
 ; IEViewAvatar
;Filename: {app}\profiles\settings.ini; Section: IEView_Template; Key: Avatars; String: b{code:SetBoolSetting|IEViewAvatar}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\update.ini; Section: IEView_Template; Key: Avatars; String: b{code:SetBoolSetting|IEViewAvatar}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\autoexec_update.ini; Section: IEView_Template; Key: Avatars; String: b{code:SetBoolSetting|IEViewAvatar}; Flags: uninsdeleteentry;  Components: resources\ieview; Check: IsUpdate;
 ; IEViewShortLink
;Filename: {app}\profiles\settings.ini; Section: IEView_Template; Key: ShortLinks; String: b{code:SetBoolSetting|IEViewShortLink}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\update.ini; Section: IEView_Template; Key: ShortLinks; String: b{code:SetBoolSetting|IEViewShortLink}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\autoexec_update.ini; Section: IEView_Template; Key: ShortLinks; String: b{code:SetBoolSetting|IEViewShortLink}; Flags: uninsdeleteentry;  Components: resources\ieview; Check: IsUpdate;
 ; IEViewContextMenu
;Filename: {app}\profiles\settings.ini; Section: IEView_Template; Key: CustomContextMenu; String: b{code:SetBoolSetting|IEViewContextMenu}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\update.ini; Section: IEView_Template; Key: CustomContextMenu; String: b{code:SetBoolSetting|IEViewContextMenu}; Flags: uninsdeleteentry; Components: resources\ieview;
;Filename: {app}\profiles\autoexec_update.ini; Section: IEView_Template; Key: CustomContextMenu; String: b{code:SetBoolSetting|IEViewContextMenu}; Flags: uninsdeleteentry;  Components: resources\ieview; Check: IsUpdate;
