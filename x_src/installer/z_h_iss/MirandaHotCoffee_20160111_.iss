...
#define AppUpdateVersion "0.95.4.13028"                                     ; product version update range
...
[Run]
; patcher
Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=xpk_hc /VERYSILENT"; Flags: runhidden; Check: IsStyleChecked('IconsXpk')
Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=nova_hc /VERYSILENT"; Flags: runhidden; Check: IsStyleChecked('IconsNova')
Filename: {app}\skins\icons\IconPatcher.exe; Parameters: "/bin=""{app}\{#AppExeName}"" /arc=fugue_hc /VERYSILENT"; Flags: runhidden; Check: IsStyleChecked('IconsFugue')
; postinstall
...
//      AddRadioButton(StylesHelper('SkinGoldtimeLight'), '', 1, False, True, nil);
      ...
      AddCheckBox(StylesHelper('Icons'), '', 0, False, True, True, False, nil);
