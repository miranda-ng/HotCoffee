...
#define AppVerBuild "5"
#define AppVerRevis "15968"
#define AppVerStatusBuild " alpha build #"
#define AppStatus "Test"                                                    ; must be Alpha Rx, Beta Rx, Final Rx or Test

#define AppShortVer AppVerMajor + "." + AppVerMinor + "." + AppVerBuild
#define AppVer AppVerMajor + "." + AppVerMinor + "." + AppVerBuild + "." + AppVerRevis
#define AppFullVer AppVerMajor + "." + AppVerMinor + "." + AppVerBuild + "." + AppVerRevis + " " + AppStatus
#define AppMirVer AppArch == "x86" ? AppShortVer + AppVerStatusBuild + AppVerRevis : AppShortVer + AppVerStatusBuild + AppVerRevis + " x64"
#define AppDevOrStub AppStatus == "Test" ? "DevelopmentVersion" : "StableVersion"

#define AppUpdateVersion "0.95.4.13028,0.95.5.15968"                        ; product version update range
...
#define SelectedStyleSettingsDefault \
    "SkinDefaultWinLight,IEViewAnimation,IEViewShortLink,FontPrinting"

#define IncompatibleDir "{app}\incompatible"                                ; incompatible dir
#define ExcludeList IncompatibleDir + ", \
                    {app}\icons, \
                    {app}\inbox, \
                    {app}\profiles, \
                    {app}\skins, \
...
#define CLUIFrames  "protocols\aim," + \
                    "protocols\facebook," + \
                    "protocols\gg," + \
                    "protocols\icq\icq," + \
                    "protocols\icq\icq2," + \
...
#endif
#if AppStatus != "Test"
OutputBaseFilename={#AppNameInstall}_{#AppVer}_{#AppArch}
#else
OutputBaseFilename={#AppNameInstall}_test_{#AppArch}
#endif
...
VersionInfoDescription={#AppName} {#AppStatus} ({#AppArch})
...
[Messages]
#if AppStatus != "Test"
BeveledLabel={#AppName} {#AppVer} ({#AppArch}) © {#AppPublisher}, 2010 - {#GetDateTimeString('yyyy', '', '')}
#else
BeveledLabel={#AppName} {#AppVer} ({#AppArch}) Test © {#AppPublisher}, 2010 - {#GetDateTimeString('yyyy', '', '')}
#endif
...
Type: files; Name: {app}\icons\proto_conn_gg.dll; Components: not protocols\gg; Check: IsPortableSetupType and IsUpdate;
 ; protocols\icq
Type: files; Name: {app}\plugins\icq.dll; Components: not (protocols\icq\icq and protocols\icq\icq2 and protocols\icq\icq3 and protocols\icq\icq4 and protocols\icq\icq5); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_icq.dll; Components: not (protocols\icq\icq and protocols\icq\icq2 and protocols\icq\icq3 and protocols\icq\icq4 and protocols\icq\icq5); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_conn_icq.dll; Components: not (protocols\icq\icq and protocols\icq\icq2 and protocols\icq\icq3 and protocols\icq\icq4 and protocols\icq\icq5); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\xstatus_icq.dll; Components: not (protocols\icq\icq and protocols\icq\icq2 and protocols\icq\icq3 and protocols\icq\icq4 and protocols\icq\icq5); Check: IsPortableSetupType and IsUpdate;
 ; protocols\icq\icq2
...
Type: files; Name: {app}\skins\myavatars\irc.png; Components: not protocols\irc; Check: IsPortableSetupType and IsUpdate;
 ; protocols\jabber
Type: files; Name: {app}\plugins\jabber.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\xstatus_jabber.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\skins\myavatars\jabber.png; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex); Check: IsPortableSetupType and IsUpdate;
 ; protocols\jabber\fb
...
Type: files; Name: {app}\icons\proto_conn_xmpp.dll; Components: not protocols\jabber\xmpp; Check: IsPortableSetupType and IsUpdate;
 ; protocols\jabber\yandex
Type: files; Name: {app}\icons\proto_yandex.dll; Components: not protocols\jabber\yandex; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_conn_yandex.dll; Components: not protocols\jabber\yandex; Check: IsPortableSetupType and IsUpdate;
 ; protocols\mra
...
Type: files; Name: {app}\plugins\tox.dll; Components: not protocols\tox; Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\icons\proto_tox.dll; Components: not protocols\tox; Check: IsPortableSetupType and IsUpdate;
 ; protocols\twitter
Type: files; Name: {app}\plugins\twitter.dll; Components: not protocols\twitter; Check: IsPortableSetupType and IsUpdate;
...
Type: filesandordirs; Name: {app}\skins\smileys\vk; Check: IsPortableSetupType and IsUpdate;
 ; protocols\whatsapp
Type: files; Name: {app}\plugins\whatsapp.dll; Components: not protocols\whatsapp; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\plugins\WART-1.6.3.0.exe; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_whatsapp.dll; Components: not protocols\whatsapp; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_conn_whatsapp.dll; Components: not protocols\whatsapp; Check: IsPortableSetupType and IsUpdate;
 ; protocols\yahoo
Type: files; Name: {app}\plugins\yahoo.dll; Components: not protocols\yahoo; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_yahoo.dll; Components: not protocols\yahoo; Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\icons\proto_conn_yahoo.dll; Components: not protocols\yahoo; Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\plugins\translitswitcher.dll; Components: not plugins\ckl; Check: IsPortableSetupType and IsUpdate;
 ; plugins\dbeditor
...
Type: files; Name: {app}\plugins\fltcontacts.dll; Components: not plugins\fltcontacts; Check: IsPortableSetupType and IsUpdate;
 ; gtalkext
Type: files; Name: {app}\plugins\gtalkext.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts); Check: IsPortableSetupType and IsUpdate;
 ; plugins\historypp
...
Type: files; Name: {app}\plugins\ignorestate.dll; Components: not plugins\ignorestate; Check: IsPortableSetupType and IsUpdate;
 ; plugins\keepstatus
Type: files; Name: {app}\plugins\keepstatus.dll; Components: not plugins\keepstatus; Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\plugins\messagestate.dll; Components: not (protocols\facebook and protocols\vkontakte); Check: IsPortableSetupType and IsUpdate;
 ; plugins\modernopt
Type: files; Name: {app}\plugins\modernopt.dll; Components: not plugins\modernopt; Check: IsPortableSetupType and IsUpdate;
 ; plugins\newxstatusnotify
Type: files; Name: {app}\plugins\newxstatusnotify.dll; Components: not plugins\newxstatusnotify; Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\skins\sounds\scan.wav; Components: not plugins\newxstatusnotify; Check: IsPortableSetupType and IsUpdate;
 ; nudge
Type: files; Name: {app}\plugins\nudge.dll; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex and protocols\mra and protocols\msn and protocols\yahoo); Check: IsPortableSetupType and IsUpdate;
Type: files; Name: {app}\skins\sounds\nudge.wav; Components: not (protocols\jabber\gmail and protocols\jabber\google and protocols\jabber\gtalk and protocols\jabber\hangouts and protocols\jabber\jabber and protocols\jabber\jabberru and protocols\jabber\lj and protocols\jabber\ok and protocols\jabber\xmpp and protocols\jabber\yandex and protocols\mra and protocols\msn and protocols\yahoo); Check: IsPortableSetupType and IsUpdate;
...
Type: files; Name: {app}\icons\flags.dll; Components: not plugins\schecker; Check: IsPortableSetupType and IsUpdate;
 ; plugins\startupstatus
Type: files; Name: {app}\plugins\startupstatus.dll; Components: not plugins\startupstatus; Check: IsPortableSetupType and IsUpdate;
 ; plugins\stopspam
...
Type: files; Name: {app}\skins\sounds\startup.wav; Components: not resources\splashscreen; Check: IsPortableSetupType and IsUpdate;
 ; resources\tipper
Type: files; Name: {app}\plugins\tipper.dll; Components: not resources\tipper; Check: IsPortableSetupType and IsUpdate;
...
Source: x86\langpack_russian.txt; DestDir: {app}\languages; Languages: ru; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\profiles\AutoSizeInputArea0.ini; DestDir: {app}\skins\tabsrmm; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\profiles\AutoSizeInputArea1.ini; DestDir: {app}\skins\tabsrmm; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\icons\tabsrmm_icons.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\icons\toolbar_icons.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\scripts\*; DestDir: {app}\scripts; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: x86\skins\sounds\hny.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: {#AppArch}\plugins\newawaysys.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: {#AppArch}\plugins\tabsrmm.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
Source: {#AppArch}\plugins\toptoolbar.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: maincore; AfterInstall: AddDetails;
...
Source: x86\skins\fonts\handwritting.ini; DestDir: {app}\profiles; DestName: autoexec_zfont.ini; Flags: ignoreversion; Components: maincore; Check: IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
...
Source: x86\icons\proto_gg.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\gg; AfterInstall: AddDetails;
 ; protocols\icq
 ; protocols\icq\icq
Source: {#AppArch}\plugins\icq.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\icq\icq or protocols\icq\icq2 or protocols\icq\icq3 or protocols\icq\icq4 or protocols\icq\icq5; AfterInstall: AddDetails;
Source: x86\icons\proto_conn_icq.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\icq\icq or protocols\icq\icq2 or protocols\icq\icq3 or protocols\icq\icq4 or protocols\icq\icq5; AfterInstall: AddDetails;
Source: x86\icons\proto_icq.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\icq\icq or protocols\icq\icq2 or protocols\icq\icq3 or protocols\icq\icq4 or protocols\icq\icq5; AfterInstall: AddDetails;
Source: x86\icons\xstatus_icq.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\icq\icq or protocols\icq\icq2 or protocols\icq\icq3 or protocols\icq\icq4 or protocols\icq\icq5; AfterInstall: AddDetails;
 ; protocols\icq\icq2
...
Source: x86\skins\myavatars\irc.png; DestDir: {app}\skins\myavatars; Flags: ignoreversion; Components: protocols\irc; AfterInstall: AddDetails;
 ; protocols\jabber
Source: {#AppArch}\plugins\jabber.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp; AfterInstall: AddDetails;
Source: x86\icons\xstatus_jabber.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp; AfterInstall: AddDetails;
Source: x86\skins\myavatars\jabber.png; DestDir: {app}\skins\myavatars; Flags: ignoreversion; Components: protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\xmpp; AfterInstall: AddDetails;
 ; protocols\jabber\gmail
...
Source: {#AppArch}\plugins\tox.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\tox; AfterInstall: AddDetails;
...
Source: x86\icons\proto_tox.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: protocols\tox; AfterInstall: AddDetails;
 ; protocols\twitter
Source: {#AppArch}\plugins\twitter.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\twitter; AfterInstall: AddDetails;
...
Source: x86\skins\myavatars\mradio.png; DestDir: {app}\skins\myavatars; Flags: ignoreversion; Components: protocols\other\mradio; AfterInstall: AddDetails;
 ; protocols\other\newsaggregator
Source: {#AppArch}\plugins\newsaggregator.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\other\newsaggregator; AfterInstall: AddDetails;
...
Source: {#AppArch}\plugins\translitswitcher.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: plugins\ckl; AfterInstall: AddDetails;
 ; plugins\dbeditor
...
Source: x86\skins\sounds\scan.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: plugins\newxstatusnotify; AfterInstall: AddDetails;
 ; nudge
Source: {#AppArch}\plugins\nudge.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp or protocols\mra or protocols\msn or protocols\yahoo; AfterInstall: AddDetails;
Source: x86\skins\sounds\nudge.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: protocols\jabber\gmail or protocols\jabber\google or protocols\jabber\gtalk or protocols\jabber\jabber or protocols\jabber\jabberru or protocols\jabber\lj or protocols\jabber\ok or protocols\jabber\xmpp or protocols\mra or protocols\msn or protocols\yahoo; AfterInstall: AddDetails;
 ; plugins\quickmessages
...
Source: x86\icons\flags.dll; DestDir: {app}\icons; Flags: ignoreversion; Components: plugins\schecker; AfterInstall: AddDetails;
 ; plugins\startupstatus
...
Source: x86\skins\ieview\!tools\icons\*; DestDir: {app}\skins\ieview\!tools\icons; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
...
Source: x86\skins\ieview\!tools\skripte\*; DestDir: {app}\skins\ieview\!tools\skripte; Flags: ignoreversion recursesubdirs createallsubdirs; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\skripte\en\*; DestDir: {app}\skins\ieview\!tools\skripte; Languages: en; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\!tools\skripte\ru\*; DestDir: {app}\skins\ieview\!tools\skripte; Languages: ru; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
...
Source: x86\skins\ieview\styles\handwritting.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
Source: x86\skins\ieview\styles\printing.css; DestDir: {app}\skins\ieview\styles; Flags: ignoreversion; Components: resources\ieview; AfterInstall: AddDetails;
...
Source: x86\skins\sounds\startup.wav; DestDir: {app}\skins\sounds; Flags: ignoreversion; Components: resources\splashscreen and resources\sounds; AfterInstall: AddDetails;
 ; resources\tipper
Source: {#AppArch}\plugins\tipper.dll; DestDir: {app}\plugins; Flags: ignoreversion; Components: resources\tipper; AfterInstall: AddDetails;
 ; resources\themes
#define public i 2
#sub AddTheme
...
#for {i = 2; i < 14; i++} AddTheme
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink off + printing font
Source: x86\skins\ieview\!tools\other\animation0_avatar0_shortlink0_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink on + printing font
Source: x86\skins\ieview\!tools\other\animation0_avatar0_shortlink1_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation off + IEViewAvatar on + IEViewShortLink off + printing font
Source: x86\skins\ieview\!tools\other\animation0_avatar1_shortlink0_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + printing font
Source: x86\skins\ieview\!tools\other\animation1_avatar0_shortlink0_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink on + printing font
Source: x86\skins\ieview\!tools\other\animation1_avatar0_shortlink1_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + printing font
Source: x86\skins\ieview\!tools\other\animation1_avatar1_shortlink0_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + printing font
Source: x86\skins\ieview\!tools\other\animation1_avatar1_shortlink1_printing\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontPrinting'); AfterInstall: AddDetails;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink off + handwritting font
Source: x86\skins\ieview\!tools\other\animation0_avatar0_shortlink0_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation off + IEViewAvatar off + IEViewShortLink on + handwritting font
Source: x86\skins\ieview\!tools\other\animation0_avatar0_shortlink1_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation off + IEViewAvatar on + IEViewShortLink off + handwritting font
Source: x86\skins\ieview\!tools\other\animation0_avatar1_shortlink0_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + handwritting font
Source: x86\skins\ieview\!tools\other\animation1_avatar0_shortlink0_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and not IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink on + handwritting font
Source: x86\skins\ieview\!tools\other\animation1_avatar0_shortlink1_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewShortLink') and not IsStyleChecked('IEViewAvatar') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + handwritting font
Source: x86\skins\ieview\!tools\other\animation1_avatar1_shortlink0_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and not IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
 ; IEViewAnimation on + IEViewAvatar off + IEViewShortLink off + handwritting font
Source: x86\skins\ieview\!tools\other\animation1_avatar1_shortlink1_handwritting\*; DestDir: {app}\skins\ieview; Flags: ignoreversion; Components: resources\ieview; Check: IsStyleChecked('IEViewAnimation') and IsStyleChecked('IEViewAvatar') and IsStyleChecked('IEViewShortLink') and IsStyleChecked('FontHandwritting'); AfterInstall: AddDetails;
...
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: Version; String: u{#AppVer} {#AppStatus};
...
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: Contacts; String: u?crlf()e-mail: {#AppContacts}?crlf()jid: hotcoffee@xmpp.ru;
...
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: Version; String: u{#AppVer} {#AppStatus};
...
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: Contacts; String: u?crlf()e-mail: {#AppContacts}?crlf()jid: hotcoffee@xmpp.ru;
...
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: Version; String: u{#AppVer} {#AppStatus}; Check: IsUpdate;
...
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: Contacts; String: u?crlf()e-mail: {#AppContacts}?crlf()jid: hotcoffee@xmpp.ru; Check: IsUpdate;
...
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: Skin; String: uwinstylel; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinWinstyleLight') and IsUpdate;
 ; icons xpk
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: IconPack; String: uxpk; Flags: uninsdeleteentry;
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: IconPack; String: uxpk; Flags: uninsdeleteentry;
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: IconPack; String: uxpk; Flags: uninsdeleteentry;
 ; smileys for the dark skin
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoFacebook-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoMRA-filename; String: uskins\smileys\_dark\mra\mra.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoMSN-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_dark\skype\skype.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoTOX-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoTwitter-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoVKontakte-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoWhatsApp-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Gmail-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Google-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: GTalk-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Hangouts-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: OK-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Yandex-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
 ;
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: AllProtoFacebook-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: AllProtoMRA-filename; String: uskins\smileys\_dark\mra\mra.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
...
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Yandex-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark');
 ;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_dark\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoFacebook-filename; String: uskins\smileys\_dark\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoMRA-filename; String: uskins\smileys\_dark\mra\mra.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinGlamourDark') or IsStyleChecked('SkinGraphiteDark') or IsStyleChecked('SkinPhotooneDark') or IsStyleChecked('SkinSurfaceBlack') or IsStyleChecked('SkinTextoliteDark') or IsStyleChecked('SkinWinstyleDark')) and IsUpdate;
...
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoFacebook-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoMRA-filename; String: uskins\smileys\_light\mra\mra.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoMSN-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_light\skype\skype.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoTOX-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoTwitter-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoVKontakte-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: AllProtoWhatsApp-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Gmail-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Google-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: GTalk-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Hangouts-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: OK-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\settings.ini; Section: SmileyAdd; Key: Yandex-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
 ;
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
...
Filename: {app}\profiles\update.ini; Section: SmileyAdd; Key: Yandex-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight');
 ;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: clist-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Standard-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: tipper-filename; String: uskins\smileys\_light\kolobok\kolobok.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoFacebook-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoMRA-filename; String: uskins\smileys\_light\mra\mra.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoMSN-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoSKYPE-filename; String: uskins\smileys\_light\skype\skype.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoTOX-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoTwitter-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoVKontakte-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: AllProtoWhatsApp-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Gmail-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Google-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: GTalk-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Hangouts-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: OK-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: SmileyAdd; Key: Yandex-filename; String: uskins\smileys\_light\emoji\emoji.msl; Flags: uninsdeleteentry; Check: (IsStyleChecked('SkinDefaultMirLight') or IsStyleChecked('SkinDefaultWinLight') or IsStyleChecked('SkinGlamourLight') or IsStyleChecked('SkinGraphiteLight') or IsStyleChecked('SkinPhotooneLight') or IsStyleChecked('SkinSurfaceWhite') or IsStyleChecked('SkinTextoliteLight') or IsStyleChecked('SkinWinstyleLight')) and IsUpdate;
 ; handwritting font
Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: Font; String: uhandwritting; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\profiles\update.ini; Section: PackInfo; Key: Font; String: uhandwritting; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: Font; String: uhandwritting; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting') and IsUpdate;
 ;
;Filename: {app}\profiles\settings.ini; Section: PackInfo; Key: FontName; String: uSegoe Print; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting');
;Filename: {app}\profiles\update.ini; Section: PackInfo; Key: FontName; String: uSegoe Print; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting');
;Filename: {app}\profiles\autoexec_update.ini; Section: PackInfo; Key: FontName; String: uSegoe Print; Flags: uninsdeleteentry; Check: IsStyleChecked('FontHandwritting') and IsUpdate;
 ;
;Filename: {app}\skins\tabsrmm\diplomatd\diplomatd.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\diplomatd; Check: IsStyleChecked('FontHandwritting');
;Filename: {app}\skins\tabsrmm\diplomatl\diplomatl.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\diplomatl; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\glamourd\glamourd.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\glamourd; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\glamourl\glamourl.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\glamourl; Check: IsStyleChecked('FontHandwritting');
;Filename: {app}\skins\tabsrmm\goldtimed\goldtimed.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\goldtimed; Check: IsStyleChecked('FontHandwritting');
;Filename: {app}\skins\tabsrmm\goldtimel\goldtimel.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\goldtimel; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\photooned\photooned.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\photooned; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\photoonel\photoonel.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\photoonel; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\surfaceb\surfaceb.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\surfaceb; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\surfacew\surfacew.tsk; Section: WindowFrame; Key: CaptionOffset; String: 4; Flags: uninsdeleteentry; Components: resources\themes\surfacew; Check: IsStyleChecked('FontHandwritting');
 ;
Filename: {app}\skins\tabsrmm\graphited\graphited.tsk; Section: WindowFrame; Key: CaptionOffset; String: 3; Flags: uninsdeleteentry; Components: resources\themes\graphited; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\graphitel\graphitel.tsk; Section: WindowFrame; Key: CaptionOffset; String: 3; Flags: uninsdeleteentry; Components: resources\themes\graphitel; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\textolited\textolited.tsk; Section: WindowFrame; Key: CaptionOffset; String: 3; Flags: uninsdeleteentry; Components: resources\themes\textolited; Check: IsStyleChecked('FontHandwritting');
Filename: {app}\skins\tabsrmm\textolitel\textolitel.tsk; Section: WindowFrame; Key: CaptionOffset; String: 3; Flags: uninsdeleteentry; Components: resources\themes\textolitel; Check: IsStyleChecked('FontHandwritting');
 ; printing font
...
Filename: {app}\profiles\settings.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b52; Flags: uninsdeleteentry; Check: not IsSettingChecked('AutoAwayDetection');
Filename: {app}\profiles\update.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b52; Flags: uninsdeleteentry; Check: not IsSettingChecked('AutoAwayDetection');
Filename: {app}\profiles\autoexec_update.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b52; Flags: uninsdeleteentry; Check: not IsSettingChecked('AutoAwayDetection') and IsUpdate;
 ; AutoAwayDetection on
Filename: {app}\profiles\settings.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b183; Flags: uninsdeleteentry; Check: IsSettingChecked('AutoAwayDetection');
Filename: {app}\profiles\update.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b183; Flags: uninsdeleteentry; Check: IsSettingChecked('AutoAwayDetection');
Filename: {app}\profiles\autoexec_update.ini; Section: AdvancedAutoAway; Key: ALLPROTOS_OptionFlags; String: b183; Flags: uninsdeleteentry; Check: IsSettingChecked('AutoAwayDetection') and IsUpdate;
 ; AutoIdleDetection
...
#endif
 ; DontSwitchToStable
Filename: {app}\profiles\settings.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|DevelopmentVersion}; Flags: uninsdeleteentry;
Filename: {app}\profiles\update.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|DevelopmentVersion}; Flags: uninsdeleteentry;
Filename: {app}\profiles\autoexec_update.ini; Section: PluginUpdater; Key: DontSwitchToStable; String: b{code:SetBoolSetting|DevelopmentVersion}; Flags: uninsdeleteentry; Check: IsUpdate;
 ; DevelopmentVersion
Filename: {app}\profiles\settings.ini; Section: PluginUpdater; Key: UpdateMode; String: b2; Flags: uninsdeleteentry; Check: IsSettingChecked('DevelopmentVersion');
Filename: {app}\profiles\update.ini; Section: PluginUpdater; Key: UpdateMode; String: b2; Flags: uninsdeleteentry; Check: IsSettingChecked('DevelopmentVersion');
Filename: {app}\profiles\autoexec_update.ini; Section: PluginUpdater; Key: UpdateMode; String: b2; Flags: uninsdeleteentry; Check: IsSettingChecked('DevelopmentVersion') and IsUpdate;
 ; DialogFontSize
...
Filename: {app}\profiles\autoexec_update.ini; Section: SRMsg; Key: LoadHistory; String: b1; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LoadHistorySize,5') and IsUpdate;
 ; LocationTabsMessageWindow on
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 51 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and IsSettingChecked('AutoSizeInputArea') and IsUpdate;
 ; LocationTabsMessageWindow off
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\settings.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and not IsSettingChecked('AutoSizeInputArea');
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,0') and not IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 44 08 3C 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,1') and not IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3D 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,2') and not IsSettingChecked('AutoSizeInputArea') and IsUpdate;
Filename: {app}\profiles\autoexec_update.ini; Section: Tab_SRMsg; Key: CNTW_Def; String: n00 00 00 00 44 11 38 40 08 3E 00 02 FF 00 FF 00 25 00 00 00 3C 00 00 00 25 00 6E 00 20 00 2D 00 20 00 25 00 73 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ; Flags: uninsdeleteentry; Check: IsAdditionalSettingChecked('LocationTabsMessageWindow,3') and not IsSettingChecked('AutoSizeInputArea') and IsUpdate;
...
function EnumChildWindows(hWndParent: HWND; lpEnumFunc, lParam: Longint): BOOL; external 'EnumChildWindows@user32.dll stdcall';
...
function DefWindowProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint; external 'DefWindowProc{#A}@user32.dll stdcall';
...
function EnumProps(hWnd: HWND; lpEnumFunc: Longint): Integer; external 'EnumProps{#A}@user32.dll stdcall';
...
function FreeLibrary(hModule: Longint): BOOL; external 'FreeLibrary@kernel32.dll stdcall';
...
function memcpyBYTE(var dest: Byte; const src: Longint; count: UINT): Longint; external 'memcpy@ntdll.dll cdecl';
function memcpyCBTCW(var dest: CBT_CREATEWND; const src: Longint; count: UINT): Longint; external 'memcpy@ntdll.dll cdecl';
...
var
    ...
    g_Border: TBitmap;
    g_pWndProc, g_pStaticWndProc, g_pButtonWndProc, g_pEditWndProc, g_pRichEditWndProc, g_pCheckListBoxWndProc, g_pListBoxWndProc,
    g_pHeaderWndProc, g_pListViewWndProc, g_pTreeViewWndProc, g_pComboBoxWndProc, g_pPageControlWndProc, g_pTabSheetWndProc, g_pUpDownWndProc: Longint;
#if aero == 1
...
begin
    ...
    for i := 0 to GetArrayLength(Names) - 1 do if Length(Names[i]) > 8 then
    begin
        szRes := '';
...
begin
    ...
    for i := 0 to iUsers.Count - 1 do
        if (CompareText(ExpandConstant('{userappdata}'), iUsers.Strings[i]) <> 0) and DirExists(Format('%s\%s', [iUsers.Strings[i], 'Microsoft\Internet Explorer\Quick Launch'])) then
            CreateShellLink(Format('%s\%s.lnk', [iUsers.Strings[i], 'Microsoft\Internet Explorer\Quick Launch\{#AppName}']), '', ExpandConstant('{app}\{#AppExeName}'), '', ExpandConstant('{app}'), '', 0, SW_SHOWNORMAL);
    iUsers.Free;
end;
...
begin
    iUsers := EnumerateCSIDLUsers(ExpandConstant('{userappdata}'));
    for i := 0 to iUsers.Count - 1 do
        if CompareText(ExpandConstant('{userappdata}'), iUsers.Strings[i]) <> 0 then
            DeleteFile(Format('%s\%s.lnk', [iUsers.Strings[i], 'Microsoft\Internet Explorer\Quick Launch\{#AppName}']));
    iUsers.Free;
end;
            ...
            try
                ...
                try
                    ...
                    begin
                        ...
                        for j := 0 to DrivesList.Count - 1 do if Pos(DrivesList.Values[DrivesList.Names[j]], szFile) = 1 then
                        begin
                        ...
                        begin
                            ...
                            begin
                                { dos name to name }
                                for j := 0 to DrivesList.Count - 1 do if Pos(DrivesList.Values[DrivesList.Names[j]], szProcess) = 1 then
                                begin
    ...
    case Param[1] of
        '!':
            begin
                ...
                for i := 0 to GetArrayLength(g_SetHelper) - 1 do if CompareText(Param, g_SetHelper[i].szInternalName) = 0 then
                begin
                    Result := Format('%d', [not SettingsPage.Values[i]]);
                    Break;
                end;
        ...
        begin
            for i := 0 to GetArrayLength(g_SetHelper)-1 do if CompareText(Param, g_SetHelper[i].szInternalName) = 0 then
            begin
                Result := Format('%d', [SettingsPage.Values[i]]);
                Break;
            end;
        end;
    end;
...
var
    i: Integer;
begin
    for i := 0 to GetArrayLength(g_StylesHelper)-1 do if CompareText(Param, g_StylesHelper[i].szInternalName) = 0 then
    begin
...
begin
    ...
    try
        CommaText := Param;
        for i := 0 to AddSettingsListBox.Items.Count - 1 do if CompareText(g_AddSetHelper[i].szInternalName, Strings[0]) = 0 then
        begin
...
begin
    ...
    begin
        for i := 0 to GetArrayLength(g_anitp.hbmFrames) - 1 do g_anitp.hbmFrames[i].Free;
        ...
        rDll:
            begin
                ...
                begin
                    ...
                    for i := 0 to uCount - 1 do g_anitp.uDelay[i] := 5;
                end;
...
begin
    ...
    try
        ...
        { draw right arrow }
            ...
            // draw background
            if sbi.rgstate[0] and STATE_SYSTEM_UNAVAILABLE = 0 then
                if PtInRect(rTemp, ptt) then iStateId := PBS_HOT else iStateId := PBS_NORMAL;
            DrawThemeBackground(g_hThemeHeader, hBufferedDC, iPartId, iStateId, rTemp, 0);
...
////////////////////////////////////////////////////////////////////////////////
#if aero == 1
function ButtonDlgProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
                    ...
                    case dwStyle and $000F of
                        ...
                        BS_DEFPUSHBUTTON:
                            begin
                                ...
                                { get caption }
                                szCaption := StringOfChar(#0, 1024);
                                GetWindowText(hWnd, szCaption, Length(szCaption));
                                szCaption := TrimRight(szCaption);
                            end;
                    end;
...
/////////////////////////////////
procedure ReleaseDlgThemeHandles;
begin
...
////////////////////////////////////////////////////////////////
function SubclassDlgControls(hWnd: HWND; lParam: Longint): BOOL;
var
    szClassName: String;
begin
    Result := True;
    ...
    { get class name }
    szClassName := StringOfChar(#0, 64);
    GetClassName(hWnd, szClassName, Length(szClassName));
    szClassName := TrimRight(szClassName);

    { case class }
    case szClassName of
        WC_STATIC:
            begin
                if GetProp(hWnd, 'STATICDLGSUBCLASS') = 0 then
                begin
                    SetProp(hWnd, 'STATICDLGSUBCLASS', 1);
                    if g_pStaticDlgProc = 0 then
                        g_pStaticDlgProc := CallbackAddr('StaticDlgProc');
                    SetWindowLong(hWnd, GWL_USERDATA, SetWindowLong(hWnd, GWL_WNDPROC, g_pStaticDlgProc));
                end;
            end;
        WC_BUTTON:
            begin
                if GetProp(hWnd, 'BUTTONDLGSUBCLASS') = 0 then
                begin
                    SetProp(hWnd, 'BUTTONDLGSUBCLASS', 1);
                    if g_pButtonDlgProc = 0 then
                        g_pButtonDlgProc := CallbackAddr('ButtonDlgProc');
                    SetWindowLong(hWnd, GWL_USERDATA, SetWindowLong(hWnd, GWL_WNDPROC, g_pButtonDlgProc));
                end;
            end;
    end;
end;
...
////////////////////////////////////////////////////
procedure SubclassDlgControlsProc(const hWnd: HWND);
var
    lpSubclassDlgControls: Longint;
begin
    { check composition }
    ...
    { subclass controls }
    GetDlgResources(hWnd);
    lpSubclassDlgControls := CallbackAddr('SubclassDlgControls');
    EnumChildWindows(hWnd, lpSubclassDlgControls, 0);
end;

//////////////////////////////////////////////////////////////////
function UnSubclassDlgControls(hWnd: HWND; lParam: Longint): BOOL;
var
    szClassName: String;
begin
    Result := True;
    ...
    case szClassName of
        WC_STATIC:
            begin
                if GetProp(hWnd, 'STATICDLGSUBCLASS') <> 0 then
                begin
                    RemoveProp(hWnd, 'STATICDLGSUBCLASS');
        ...
        WC_BUTTON:
            begin
                if GetProp(hWnd, 'BUTTONDLGSUBCLASS') <> 0 then
                begin
                    RemoveProp(hWnd, 'BUTTONDLGSUBCLASS');
                    if GetWindowLong(hWnd, GWL_USERDATA) <> 0 then
                        SetWindowLong(hWnd, GWL_WNDPROC, GetWindowLong(hWnd, GWL_USERDATA));
                end;
            end;
...
/////////////////////////////////////////////////////
procedure UnSubclassDlgControlsProc(const hWnd: HWND);
var
    lpUnSubclassDlgControls: Longint;
begin
    { unsubclass childs }
    lpUnSubclassDlgControls := CallbackAddr('UnSubclassDlgControls');
    EnumChildWindows(hWnd, lpUnSubclassDlgControls, 0);

    { unsubclass dialog }
    if GetProp(hWnd, 'DLGPREVPROC') <> 0 then
    begin
        RemoveProp(hWnd, 'DLGPREVPROC');
        SetWindowLong(hWnd, GWL_WNDPROC, GetProp(hWnd, 'DLGPREVPROC'));
    end;
end;

//////////////////////////////////////////////////////////////////////////
function DlgProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    margins: MARGINS;
    ps: PAINTSTRUCT;
    rClient: TRect;
...
begin
    case Msg of
        WM_INITDIALOG:
            begin
                SubclassDlgControlsProc(hWnd);
                Result := CallWindowProc(GetProp(hWnd, 'DLGPREVPROC'), hWnd, Msg, wParam, lParam);
            end;
        ...
        WM_DESTROY:
            UnSubclassDlgControlsProc(hWnd);
    else
        Result := CallWindowProc(GetProp(hWnd, 'DLGPREVPROC'), hWnd, Msg, wParam, lParam);
    end;
end;
...
begin
    ...
    case nCode of
        HCBT_CREATEWND:
            begin
                memcpyLONG(lpcw, lParam, SizeOf(lpcw));
                memcpyCBTCW(cw, lpcw, SizeOf(cw));
                if cw.lpcs.lpszClass = WC_DIALOG then
                begin
                    if g_pDlgProc = 0 then
                        g_pDlgProc := CallbackAddr('DlgProc');
                    SetProp(wParam, 'DLGPREVPROC', SetWindowLong(wParam, GWL_WNDPROC, g_pDlgProc));
                end;
                Result := 0;
            end;
    end;
...
////////////////////////////////////////////////////////////////
function StoreAeroControl(const AControl: TWinControl): Boolean;
var
    i: Integer;
begin
    Result := Assigned(AControl) and (GetProp(AControl.Handle, 'AERO_CONTROL_INDEX') = 0);
    if Result then
    begin
        i := GetArrayLength(g_AeroControls) + 1;
        SetArrayLength(g_AeroControls, i);
        g_AeroControls[i - 1] := AControl;
        SetProp(AControl.Handle, 'AERO_CONTROL_INDEX', i - 1);
    end;
end;

///////////////////////////////////////////////////////
function RestoreAeroControl(const hWnd: HWND): Boolean;
begin
    Result := GetWindowLong(hWnd, GWL_USERDATA) <> 0;
    if Result then
    begin
        RemoveProp(hWnd, 'AERO_CONTROL_INDEX');
        SetWindowLong(hWnd, GWL_WNDPROC, GetWindowLong(hWnd, GWL_USERDATA));
    end;
end;
...
begin
    ...
    begin
        ...
        if GetWindowLong(Handle, GWL_USERDATA) = 0 then
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pWndProc));
    end;
end;
...
begin
    { initial settings }
    if GetArrayLength(g_AeroControls) = 0 then
        SetArrayLength(g_AeroControls, 1);   // GetProp fix
    if g_fEnabled then
        crColor := clBackground
    else
        crColor := clBtnFace;
...
#if aero == 0 || aero == 1
    { TNewNotebook }
    if AControl is TNewNotebook then with TNewNotebook(AControl) do
    begin
        for i := 0 to PageCount - 1 do Pages[i].Color := crColor;
    end;
#endif

    { TPanel }
    if AControl is TPanel then with TPanel(AControl) do
    begin
        if g_fEnabled then
            Color := clBackground
        else
    ...
    { TNewStaticText }
    if AControl is TNewStaticText then with TNewStaticText(AControl) do
    begin
        { settings }
        ...
        { store control }
        if StoreAeroControl(TWinControl(AControl)) then
        begin
            { subclass }
            if g_pStaticWndProc = 0 then
                g_pStaticWndProc := CallbackAddr('StaticWndProc');
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pStaticWndProc));
        end;
    end;

    { TButtonControl }
    if AControl is TButtonControl then with TButtonControl(AControl) do
    begin
        { settings }
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pButtonWndProc));
        end;
    end;

    { TEdit, TNewMemo }
    if (AControl is TEdit) or (AControl is TNewMemo) then with TCustomEdit(AControl) do
    begin
        { settings }
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pEditWndProc));
        end;
    end;

    { TRichEditViewer }
    if AControl is TRichEditViewer then with TRichEditViewer(AControl) do
    begin
        { store control }
        if StoreAeroControl(TWinControl(AControl)) then
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pRichEditWndProc));
        end;
    end;

    { TNewComboBox }
    if AControl is TNewComboBox then with TNewComboBox(AControl) do
    begin
        { store control }
        if StoreAeroControl(TWinControl(AControl)) then
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pComboBoxWndProc));
            ...
            begin
                ...
                if GetComboBoxInfo(Handle, cbi) then
                    SetWindowLong(cbi.hwndList, GWL_USERDATA, SetWindowLong(cbi.hwndList, GWL_WNDPROC, CallbackAddr('TypesComboListBoxWndProc')));
            end;
        end;
    end;
    ...
    begin
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pHeaderWndProc));
        end;
    end;

    { TListView }
    if AControl is TListView then with TListView(AControl) do
    begin
        { settings }
        SetWindowLong(Handle, GWL_EXSTYLE, GetWindowLong(Handle, GWL_EXSTYLE) or (DWORD(g_fEnabled) * WS_EX_COMPOSITED));
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pListViewWndProc));
        end;
    end;

    { TStartMenuFolderTreeView }
    if AControl is TStartMenuFolderTreeView then with TStartMenuFolderTreeView(AControl) do
    begin
        { settings }
        SetWindowLong(Handle, GWL_EXSTYLE, GetWindowLong(Handle, GWL_EXSTYLE) or (DWORD(g_fEnabled) * WS_EX_COMPOSITED));
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pTreeViewWndProc));
        end;
    end;

    { TNewCheckListBox }
    if AControl is TNewCheckListBox then with TNewCheckListBox(AControl) do
    begin
        { settings }
        Color := crColor;
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pCheckListBoxWndProc));
        end;
    end;

    { TListBox }
    if AControl is TListBox then with TListBox(AControl) do
    begin
        { settings }
        Color := crColor;
        SetWindowLong(Handle, GWL_EXSTYLE, GetWindowLong(Handle, GWL_EXSTYLE) or (DWORD(g_fEnabled) * WS_EX_COMPOSITED));
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pListBoxWndProc));
        end;
    end;

    { TPageControl }
    if AControl is TPageControl then with TPageControl(AControl) do
    begin
        { settings }
        ...
        begin
            ...
            begin
                ...
                SetWindowLong(hUpDownCtrl, GWL_USERDATA, SetWindowLong(hUpDownCtrl, GWL_WNDPROC, g_pUpDownWndProc));
            end;
        end;
        ...
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pPageControlWndProc));
        end;
    end;

    { TTabSheet }
    if AControl is TTabSheet then with TTabSheet(AControl) do
    begin
        { store control }
        if StoreAeroControl(TWinControl(AControl)) then
        begin
            ...
            SetWindowLong(Handle, GWL_USERDATA, SetWindowLong(Handle, GWL_WNDPROC, g_pTabSheetWndProc));
        end;
    end;

    { TBevel }
    if AControl is TBevel then with TBevel(AControl) do
    begin
...
begin
    ...
    { TSelectLanguageForm }
    if AForm is TSelectLanguageForm then with TSelectLanguageForm(AForm) do
    begin
        with IconBitmapImage.Bitmap do
            DrawIconEx(Canvas.Handle, 0, 0, Application.Icon.Handle, Width, Height, 0, hbrBackground, DI_NORMAL);
    end;

    { TWizardForm }
    if AForm is TWizardForm then with TWizardForm(AForm) do
    begin
        ...
        begin
            hInst := GetModuleHandle('user32');
            hRes := FindResource(hInst, 33, RT_ICON);   // 33 - id icon 32x32 32-bit user32.dll
            hIcon := CreateIconFromResourceEx(LockResource(LoadResource(hInst, hRes)), SizeofResource(hInst, hRes), True, $00030000, Width, Height, LR_SHARED);
    ...
    { PreviewForm }
    if AForm = PreviewForm then with PreviewForm do
    begin
...
///////////////////////////////////////////////////////////////////////////////////////
procedure SubclassControlsProc(const AWinControl: TWinControl; const Recurse: Boolean);
var
    i: Integer;
begin
#if aero != 0
...
begin
    ...
    begin
        ...
        begin
            cbi.cbSize := SizeOf(cbi);
            if GetComboBoxInfo(Handle, cbi) then
                if GetWindowLong(cbi.hwndList, GWL_USERDATA) <> 0 then
                    SetWindowLong(cbi.hwndList, GWL_WNDPROC, GetWindowLong(cbi.hwndList, GWL_USERDATA));
        end;
    end;
    ...
    begin
        ...
        begin
            hUpDownCtrl := FindWindowEx(Handle, 0, 'msctls_updown32', '');
            if (hUpDownCtrl <> 0) and (GetWindowLong(hUpDownCtrl, GWL_USERDATA) <> 0) then
                SetWindowLong(hUpDownCtrl, GWL_WNDPROC, GetWindowLong(hUpDownCtrl, GWL_USERDATA));
        end;
        RestoreAeroControl(Handle);
    end;
...
////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////
function TypesComboEditWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
begin
    case Msg of
        WM_NCHITTEST: begin
...
///////////////////////////////////////////////////////////////////////////////////////////
function TypesComboListBoxWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
begin
    case Msg of
        WM_NCHITTEST: begin
            ComponentListInfoLabel.Caption := g_TypesHelper[WizardForm.TypesCombo.ItemIndex].szDescription;
...
begin
    case Button of
        mbLeft: WizardForm.NextButton.Enabled := IsComponentSelected('protocols');
    end;
end;
...
//            AddRadioButton(StylesHelper('SkinGoldtimeLight'), '', 1, False, True, nil);
            ...
            AddRadioButton(StylesHelper('FontHandwritting'), '', 1, False, True, nil);
...
begin
    case TObject(Sender) of
        StartMenuTreeView: WizardForm.GroupEdit.Text := AddBackslash(StartMenuTreeView.Directory) + '{#SetupSetting("DefaultGroupName")}';
...
begin
    ...
    begin
	    with TNewCheckListBox(Sender) do
	    begin
            for i := 0 to GetArrayLength(g_TasksHelper) - 1 do if CompareText(g_TasksHelper[i].szName, ItemCaption[Index]) = 0 then
            begin
...
begin
    case TNewButton(Sender).Caption of
        CustomMessage('SetupShowDetails'): begin
            DetailsMemo.Show;
            TNewButton(Sender).Caption := CustomMessage('SetupHideDetails');
        end;
        CustomMessage('SetupHideDetails'): begin
            DetailsMemo.Hide;
...
////////////////////////////////////////////////////////////////////////////////
function StaticDlgProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
    rClient: TRect;
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        try
                            { get caption }
                            szCaption := StringOfChar(#0, GetWindowTextLength(hWnd) + 1);
                            GetWindowText(hWnd, szCaption, Length(szCaption));
                            szCaption := TrimRight(szCaption);
                            ...
                            begin
                                ...
                                if dwStyle and WS_DISABLED = 0 then
                                    ...
                                    dtt.crText := GetSysColor(COLOR_INACTIVECAPTIONTEXT);
                                hFontOld := SelectObject(hBufferedDC, SendMessage(hWnd, WM_GETFONT, 0, 0));
                                DrawThemeTextEx(g_hThemeTreeView, hBufferedDC, 0, 0, StrToWStr(szCaption), -1, dwFlags, rClient, dtt);
                                if hFontOld <> 0 then
                                    SelectObject(hBufferedDC, hFontOld);
                            end;
...
//////////////////////////////////////////////////////////////////////////////////////
function CheckListBoxWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    hDC, hPaintBuffer, hTempPaintBuffer, hSelPaintBuffer, hBufferedDC, hTempBufferedDC, hSelBufferedDC, hFontOld, hBrush: THandle;
    ...
    case Msg of
        ...
        WM_PAINT:
            begin
                ...
                if g_fEnabled then
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TNewCheckListBox(g_AeroControls[idx]) do if Showing then
                    begin
                        { paint to buffer }
                        hDC := GetDC(hWnd);
                        try
                        ...
                        { temp buffer for text rect detection }
                            ...
                            begin
                                ...
                                if GetDIBits(hTempBufferedDC, hBitmap, rClient.Bottom - rTemp.Top - 1, 1, bi.bmiColors[0], bi, 0) = 1 then
                                    repeat rTemp.Left := rTemp.Left + 1 until (rTemp.Left = GetArrayLength(bi.bmiColors) - 1) or (bi.bmiColors[rTemp.Left] = 0);
                                ...
                                DrawText(hBufferedDC, StrToWStr(Items.Strings[i]), -1, rText, DT_CALCRECT or DT_LEFT or DT_WORDBREAK or DT_WORD_ELLIPSIS);
                                ...
                                for j := k to ItemCount-1 do if ItemCaption[j] = Items.Strings[i] then Break;
                                k := j;
                                ...
                                begin
                                    ...
                                    DrawThemeTextEx(g_hThemeTreeView, hSelBufferedDC, 0, 0, StrToWStr(Items.Strings[i]), -1, DT_LEFT or DT_WORDBREAK or DT_WORD_ELLIPSIS, rText, dtt);
                                ...
                                begin
                                    ...
                                    if ItemEnabled[j] then
                                        ...
                                        dtt.crText := GetSysColor(COLOR_INACTIVECAPTIONTEXT);
                                    DrawThemeTextEx(g_hThemeTreeView, hBufferedDC, 0, 0, StrToWStr(Items.Strings[i]), -1, DT_LEFT or DT_WORDBREAK or DT_WORD_ELLIPSIS, rText, dtt);
...
/////////////////////////////////////////////////////////////////////////////////
function ListBoxWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    i, idx: Integer;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
    rTemp, rClient: TRect;
    ...
    case Msg of
        ...
        WM_PAINT:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TListBox(g_AeroControls[idx]) do if Showing then
                    begin
                        { paint }
                        hDC := GetDC(hWnd);
                        try
                            ...
                            begin
                                ...
                                dtt.dwFlags := DTT_GLOWSIZE or DTT_COMPOSITED or DTT_TEXTCOLOR;
                                dtt.crText := GetSysColor(COLOR_CAPTIONTEXT);
                                DrawThemeTextEx(g_hThemeTreeView, hBufferedDC, 0, 0, StrToWStr(Items.Strings[i]), -1, dwFlags, rTemp, dtt);
                                if hFontOld <> 0 then
                                    SelectObject(hBufferedDC, hFontOld);
                            end;
...
////////////////////////////////////////////////////////////////////////////////
function HeaderWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
    pt: TPoint;
    rTemp, rClient: TRect;
    szText: String;
    iPartId, iStateId, i, idx, iHotItem: Integer;
    dtt: DTTOPTS;
    dwFlags: DWORD;
    ...
    case Msg of
        ...
        WM_PAINT:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with THeaderControl(g_AeroControls[idx]) do if Showing then
                    begin
                        { paint to buffer }
                        hDC := BeginPaint(hWnd, ps);
                        try
...
//////////////////////////////////////////////////////////////////////////////////
function ListViewWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    ...
    szItem: String;
    dtt: DTTOPTS;
    i, j, iPartId, iStateId, iHotItem, idx: Integer;
    dwFlags: DWORD;
    hWndHeader: HWND;
begin
    case Msg of
        ...
        WM_ERASEBKGND:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TListView(g_AeroControls[idx]) do if Showing then
                    begin
                        { exclude header }
                        ...
                        begin
                            ...
                            if (TListView(g_AeroControls[idx]) = g_DriveListView) and (i = TopItem.Index) then Continue;
        ...
        WM_LBUTTONDOWN:
            begin
                if hWnd <> g_PrepareListView.Handle then
                    Result := CallWindowProc(GetWindowLong(hWnd, GWL_USERDATA), hWnd, Msg, wParam, lParam);
            end;
        WM_HSCROLL:
            begin
                Result := CallWindowProc(GetWindowLong(hWnd, GWL_USERDATA), hWnd, Msg, wParam, lParam);
                if hWnd = g_DriveListView.Handle then
                begin
...
//////////////////////////////////////////////////////////////////////////////////
function TreeViewWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    ...
    pszItem: Longint;
    dtt: DTTOPTS;
    iPartId, iStateId, idx, cx, cy: Integer;
    dwFlags: DWORD;
    tvi: TVITEM;
    tvhti: TVHITTESTINFO;
begin
    case Msg of
        ...
        WM_PAINT:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TStartMenuFolderTreeView(g_AeroControls[idx]) do if Showing then
                    begin
                        { paint to buffer }
                        hDC := BeginPaint(hWnd, ps);
                        try
...
//////////////////////////////////////////////////////////////////////////////////
function ComboBoxWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    rClient: TRect;
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
...
begin
    ...
    case Msg of
        ...
        WM_MOUSEHOVER:
            begin
                with TNewComboBox(g_AeroControls[idx]) do if Showing then
                begin
                    if TNewComboBox(g_AeroControls[idx]).Name = 'TypesCombo' then   // typescombo
                    begin
                        ComponentListInfoLabel.Caption := g_TypesHelper[TNewComboBox(g_AeroControls[idx]).ItemIndex].szDescription;
                        ComponentListInfoLabel.Enabled := True;
                    end;
                    if g_fEnabled then
                    begin
                        SetProp(hWnd, 'AERO_COMBOBOX_READONLYSTATES', CBRO_HOT);
                        TNewComboBox(g_AeroControls[idx]).Invalidate;
                    end;
                end;
            end;
        WM_MOUSELEAVE:
...
//////////////////////////////////////////////////////////////////////////////
function RichEditWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
...
//////////////////////////////////////////////////////////////////////////////
function EditWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    ...
    szLine: String;
    dtt: DTTOPTS;
    iStartLine, iEndLine, iSelFirst, iSelLast, iSelFirstLine, iSelLastLine, iFirstPos, iSelFirstPos, iFirst, iFirstOffsetX, i, idx: Integer;
    dwStyle: DWORD;
                ...
                begin
                    ...
                    try
                        ...
                        begin
                            ...
                            if iEndLine = -1 then
                                iEndLine := TCustomMemo(g_AeroControls[idx]).Lines.Count - 1;
                        end;

                        { get selection range }
                        iSelFirst := TCustomEdit(g_AeroControls[idx]).SelStart;
                        iSelLast := iSelFirst + TCustomEdit(g_AeroControls[idx]).SelLength;
                        ...
                        begin
                            ...
                            if g_AeroControls[idx] is TEdit then
                                szLine := TEdit(g_AeroControls[idx]).Text;
                            if g_AeroControls[idx] is TNewMemo then
                                szLine := TNewMemo(g_AeroControls[idx]).Lines.Strings[i];
                            if dwStyle and ES_MULTILINE <> 0 then
                        ...
                        dtt.iGlowSize := 6;
                        dtt.dwFlags := DTT_GLOWSIZE or DTT_COMPOSITED or DTT_TEXTCOLOR;
                        if TCustomEdit(g_AeroControls[idx]).Enabled then
                            dtt.crText := GetSysColor(COLOR_CAPTIONTEXT)
                        else
                            dtt.crText := GetSysColor(COLOR_INACTIVECAPTIONTEXT);
...
////////////////////////////////////////////////////////////////////////////////
function StaticWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
    rClient: TRect;
    ...
    case Msg of
        WM_PAINT:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TNewStaticText(g_AeroControls[idx]) do if Showing then
                    begin
                        { paint to buffer }
                        hDC := BeginPaint(hWnd, ps);
                        try
...
////////////////////////////////////////////////////////////////////////////////
function ButtonWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    pt: TPoint;
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
                ...
                begin
                    ...
                    case dwStyle and $000F of
                        ...
                        BS_DEFPUSHBUTTON:
                            begin
                                iPartId := BP_PUSHBUTTON;
                                if TNewButton(g_AeroControls[idx]).Enabled then
                                    iStateId := PBS_NORMAL
                                else
                                    iStateId := PBS_DISABLED;
                                dwFlags := DT_SINGLELINE or DT_CENTER or DT_VCENTER;
                                szCaption := TNewButton(g_AeroControls[idx]).Caption;
                            end;
                        BS_RADIOBUTTON,
                        BS_AUTORADIOBUTTON:
                            begin
                                iPartId := BP_RADIOBUTTON;
                                if TNewRadioButton(g_AeroControls[idx]).Enabled then
                                ...
                                szCaption := TNewRadioButton(g_AeroControls[idx]).Caption;
                            end;
                        BS_CHECKBOX,
                        BS_AUTOCHECKBOX,
                        BS_3STATE,
                        BS_AUTO3STATE:
                            begin
                                iPartId := BP_CHECKBOX;
                                if TNewCheckBox(g_AeroControls[idx]).Enabled then
                                ...
                                GetThemePartSize(g_hThemeButton, 0, iPartId, iStateId, 0, TS_DRAW, pt);
                                rClient.Left := pt.x + 4;    // padding
                                szCaption := TNewCheckBox(g_AeroControls[idx]).Caption;
                            end;
                    end;
                    ...
                    try
                        ...
                        dtt.iGlowSize := 6;
                        dtt.dwFlags := DTT_GLOWSIZE or DTT_COMPOSITED or DTT_TEXTCOLOR;
                        if TButtonControl(g_AeroControls[idx]).Enabled then
                            dtt.crText := GetSysColor(COLOR_CAPTIONTEXT)
                        else
                            dtt.crText := GetSysColor(COLOR_INACTIVECAPTIONTEXT);
                        hFontOld := SelectObject(hBufferedDC, SendMessage(hWnd, WM_GETFONT, 0, 0));
...
/////////////////////////////////////////////////////////////////////////////////////
function PageControlWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    rClient, rTab: TRect;
    ps: PAINTSTRUCT;
    hDC, hPaintBuffer, hBufferedDC, hFontOld: THandle;
    ...
    case Msg of
        ...
        WM_PAINT:
            begin
                ...
                begin
                    idx := GetProp(hWnd, 'AERO_CONTROL_INDEX');
                    with TPageControl(g_AeroControls[idx]) do if Showing then
                    begin
                        hDC := BeginPaint(hWnd, ps);
                        try
                            { create buffer }
...
////////////////////////////////////////////////////////////////////////////////
function UpDownWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    pt: TPoint;
...
//////////////////////////////////////////////////////////////////////////////////
function TabSheetWndProc(hWnd: HWND; Msg: UINT; wParam, lParam: Longint): Longint;
var
    rClient: TRect;
    ps: PAINTSTRUCT;
begin
...
//                    'resources\themes\goldtimed',
        ...
        // types
    for i := 0 to GetArrayLength(g_TypesHelper) - 1 do if CompareText(g_TypesHelper[i].szInternalName, GetSetupPreviousDataEx('Inno Setup: Setup Type', '{#TypeDefault}')) = 0 then
    begin
    ...
    try
        ...
        try
            ...
            for i := 0 to Count - 1 do if Pos(Format('%s,', [Strings[i]]), S) = 0 then
    ...
    begin
        ...
        try
            CommaText := g_AddSetHelper[i].szInternalValues;
            for j := 0 to Count - 1 do if CompareText(Trim(Strings[j]), S) = 0 then
            begin
    ...
    try
        ...
        try
            ...
            for i := 0 to Count - 1 do if Pos(Strings[i], S) = 0 then
                TempList.Add(Strings[i]);
        finally
            Free;
        end;
...
//                    'resources\themes\goldtimed',
        ...
        // types
    for i := 0 to GetArrayLength(g_TypesHelper) - 1 do if CompareText(g_TypesHelper[i].szInternalName, ExpandConstant('{ini:{app}\profiles\{#AppINI},{#AppNameSetup},SetupType|{#TypeDefault}}')) = 0 then
    begin
        WizardForm.TypesCombo.ItemIndex := i;
        Break;
    end;
...
/////////////////////////////////////////////////////////////////////////////////
function PinToStartMenu(const szFilename: String; const IsPin: Boolean): Boolean;
var
    hInst: THandle;
    buf: array [0..259] of Char;
    i, res: Integer;
    szNewLnk, szVerb: String;
    objShell, colVerbs: Variant;
begin
    Result := False;
    ...
    begin
        if IsPin then
        begin
            szFilename := CreateShellLink(ExpandConstant('{tmp}\{#AppStartMenuLnk}.lnk'), '', ExpandConstant('{app}\{#AppExeName}'), '', '', '', 0, SW_SHOWNORMAL);   // create temp shortcut with needed name
            if SHGetNewLinkInfo(szFilename, GetTempDir, buf[0], res, 0) then
            begin
                while buf[Length(szNewLnk)] <> #0 do Insert(buf[Length(szNewLnk)], szNewLnk, Length(szNewLnk)+1);
                if FileExists(ExpandConstant('{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\StartMenu\') + ExtractFileName(szNewLnk)) then Exit;
            end;
        end;
    end;
    if IsPin then res := 5381 else res := 5382;
    hInst := LoadLibraryEx(ExpandConstant('{sys}\shell32.dll'), 0, LOAD_LIBRARY_AS_DATAFILE);
    if hInst <> 0 then
    try
        for i := 0 to LoadString(hInst, res, buf[0], 255)-1 do Insert(buf[i], szVerb, i+1);
        try
            objShell := CreateOleObject('Shell.Application');
            if GetWindowsVersion < $06010000 then
            begin
                objShell.Namespace(ExtractFileDir(szFilename)).ParseName(ExtractFileName(szFilename)).InvokeVerb(szVerb);
                Result := True;
            end;
            if GetWindowsVersion >= $06010000 then
            begin
                colVerbs := objShell.Namespace(ExtractFileDir(szFilename)).ParseName(ExtractFileName(szFilename)).Verbs;
                for i := 1 to colVerbs.Count do if CompareText(colVerbs.Item[i].Name, szVerb) = 0 then
                begin
                    colVerbs.Item[i].DoIt;
                    Result := True;
                    Break;
...
/////////////////////////////////////////////////////////////
function GetFileMachineType(const szFileName: String): DWORD;
var
    hFile, hMapObject: THandle;
    lpBase: Longint;
    aBuff: array [0..1] of Byte;
    dwBuff: DWORD;
begin
    Result := 0;
    ...
    try
        ...
        memcpyBYTE(aBuff[0], lpBase, SizeOf(aBuff));                                           // read DOS header signature
        if CompareText(Format('%s%s', [Chr(aBuff[0]), Chr(aBuff[1])]), 'MZ') <> 0 then Exit;   // exit if not PE-file
        memcpyDWORD(dwBuff, lpBase + $3C, SizeOf(dwBuff));                                     // get PE header offset
        if dwBuff < $80 then Exit;                                                             // exit if DOS stub size less than 64 bytes
        memcpyBYTE(aBuff[0], lpBase + dwBuff, SizeOf(aBuff));                                  // read PE header
        if CompareText(Format('%s%s', [Chr(aBuff[0]), Chr(aBuff[1])]), 'PE') <> 0 then Exit;   // exit if not PE-header
        memcpyBYTE(aBuff[0], lpBase + dwBuff + 4, SizeOf(aBuff));                              // read IMAGE_FILE_HEADER struct Machine member
        Result := (DWORD(aBuff[1]) shl $8) or DWORD(aBuff[0]);
    finally
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        case GetFileMachineType(FR.Name) of
                        #if AppArch == "x86"
            ...
            begin
                ...
                begin
                    ...
                    try
                        ...
                        for i := 0 to Count - 1 do
                        begin
                            for j := 0 to GetArrayLength(g_TasksHelper) - 1 do if CompareText(Strings[i], g_TasksHelper[j].szInternalName) = 0 then
                            begin
...
begin
    if FileExists(ExpandConstant('{app}\profiles\{#AppINI}')) then
        ...
        try
            ...
            for i := 0 to Count - 1 do if CompareText(Names[i], 'UninstallFiles') = 0 then
            begin
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        for i := 0 to g_DriveListView.Items.Count - 1 do if Pos(Lowercase(RemoveBackslash(ExtractFileDrive(WizardForm.DirEdit.Text))), Lowercase(g_DriveListView.Items.Item[i].Caption)) > 0 then
                        begin
        ...
        ssPostInstall:
            begin
                ...
                begin
                    ...
                    with TStringList.Create do
                    try
                        for i := 0 to WizardForm.ComponentsList.ItemCount - 1 do if not WizardForm.ComponentsList.Checked[i] then
                    ...
                    try
                        // selected
                        for i := 0 to SettingsPage.CheckListBox.ItemCount-1 do if SettingsPage.CheckListBox.Checked[i] then
                            Add(g_SetHelper[i].szInternalName);
                        SetIniString('{#AppNameSetup}', 'SelectedSettings', CommaText, ExpandConstant('{app}\profiles\{#AppINI}'));

                        // deselected
                        Clear;
                        for i := 0 to SettingsPage.CheckListBox.ItemCount-1 do if not SettingsPage.CheckListBox.Checked[i] then
                            Add(g_SetHelper[i].szInternalName);
                    ...
                    { additional settings }
                    for i := 0 to AddSettingsListBox.Items.Count - 1 do if AddSettingsListBox.Items.Objects[i] is TNewComboBox then
                    with TStringList.Create do
                    try
                        CommaText := g_AddSetHelper[i].szInternalValues;
                        for j := 0 to Count - 1 do if CompareText(CustomMessage(Strings[j]), TNewComboBox(AddSettingsListBox.Items.Objects[i]).Text) = 0 then
                        begin
                    ...
                    try
                        // selected
                        for i := 0 to StylesPage.CheckListBox.ItemCount-1 do if StylesPage.CheckListBox.Checked[i] then
                        ...
                        // deselected
                        Clear;
                        for i := 0 to StylesPage.CheckListBox.ItemCount-1 do if not StylesPage.CheckListBox.Checked[i] then
                            Add(g_StylesHelper[i].szInternalName);
