...
function getandsenddata(eingangsmeldung,chatpartner,basispfad,uinchatpartner,cid) {    
  ...
  case 'ausgehend':
    ...
    document.write('Файл [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+datei +'" title="'+ datei +'">'+ dateiname +'</a>] из папки [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+ dateipfad +'" title="'+ dateipfad +'">'+ dateipfadkurz +'</a>] отправлен ');   
  break;
  case 'eingehend':
    ...
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write('Файл [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+datei +'" title="'+datei +'">'+ dateiname +'</a>] от ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> получен ');
  break;
  case 'multiausgehend':
    ...
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write(dateianzahl +' к ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> отправлены ');
  break;  
  case 'multieingehend':
    //Pfadermittlung fьr ausgehende Transfers mit 2+ Dateien
    chatpartnerordner = chatpartnerordner.substring(7,chatpartnerordner.length);  
    ...
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write(dateianzahl +' от ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> получены ');   
  break;
  default:
  break;
  }
  ...
  for (i=0; i<bildendungen.length; i++) {
    if (eingangsmeldung.search(bildendungen[i]) != -1 ) {
      bildpfad = datei;
      ausgabe = '<img src="'+iconpfad+icon+'" class="icons_filetypes" onmouseover="src=\''+iconpfad+icon_d+'\';" onmouseout="src=\''+iconpfad+icon+'\';" onmousedown="picturearea(document.getElementById(\''+randomid+'pic\'),this.alt)" title="Показать/скрыть" alt="'+datei+'[trenn]'+bildpfad+'[trenn]'+randomid+'">';
  ...
  for (i=0; i<videoendungen.length; i++) {
    if (eingangsmeldung.search(videoendungen[i]) != -1 ) {
      ...
      ausgabe = '<img src="'+iconpfad+icon+'" class="icons_filetypes" onMouseOver="src=\''+iconpfad+icon_d+'\'" onMouseOut="src=\''+iconpfad+icon+'\'" onmousedown="videoarea(document.getElementById(\''+randomid+'div\'),this.alt,0)" title="Показать/скрыть" alt="'+datei+'[trenn]'+randomid+'">';
      document.getElementById(randomid+'button').innerHTML=ausgabe;
  ...
  if (gefunden==false) {
     ausgabe = '<img src="'+iconpfad+icon+'" class="icons_filetypes" onmouseover="src=\''+iconpfad+icon_d+'\';" onmouseout="src=\''+iconpfad+icon+'\';" onmousedown="otherarea(document.getElementById(\''+randomid+'other\'),this.alt)" title="Показать/скрыть" alt="'+ datei + '">';
     document.getElementById(randomid+'button').innerHTML=ausgabe;
