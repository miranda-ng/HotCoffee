    ...
    switch (gefunden) {
      case "bild":
        ...
        if (vorschaubuttonstatus.charAt(0)==1) {
          teiltext0ersatz = teiltext0ersatz+'<img src="'+imagespfad+'picture_go.png" class="icons" onmouseover="src=\''+imagespfad+'picture_go_d.png\';" onmouseout="src=\''+imagespfad+'picture_go.png\';" onmousedown="picturearea(document.getElementById(\''+name+'div\'),this.alt)" title="Show/Hide" alt="'+link+'[trenn]'+bildlink+'[trenn]'+name+'">';
        }
	...
	if ( (direktAnzeigeURLBild == "yes") || (direktAnzeigeURLBild == "ja") ) {
      ...
      case "video":
        ...
        if (vorschaubuttonstatus.charAt(4)==1) {
          teiltext0ersatz = teiltext0ersatz+'<img src="'+imagespfad+'\\'+Video_Bild+'1'+Video_Bild_Endung+'" class="icons" onMouseOver="src=\''+imagespfad+''+Video_Bild+'1_d'+Video_Bild_Endung+'\'" onMouseOut="src=\''+imagespfad+''+Video_Bild+'1'+Video_Bild_Endung+'\'" onmousedown="videoarea(document.getElementById(\''+name+'div\'),this.alt,0)" title="Video area Show/Hide" alt="'+link+'[trenn]'+name+'">';
      ...
      case "swf":
        teiltext0ersatz = "";
        if (vorschaubuttonstatus.charAt(6)==1) { teiltext0ersatz = teiltext0ersatz+'<img src="'+imagespfad+'show.png" class="icons" onmouseover="src=\''+imagespfad+'show_d.png\';" onmouseout="src=\''+imagespfad+'show.png\'" onmousedown="swfarea(document.getElementById(\''+name+'div\'),this.alt)" title="Animation area Show/Hide" alt="'+link+'[trenn]'+name+'">'; }
        if ((linkanklickbar.toLowerCase()=="yes") || (linkanklickbar.toLowerCase()=="ja")) {
          teiltext0ersatz = teiltext0ersatz+'<a href="'+link+'" class="Link-Text" onmousemove="mausdrauf(this.alt);" onmouseout="this.className=\'Link-Text\';mausrunter();" onmouseover="this.className=\'Link-Text2\';mausdrauf(this.alt);" alt="'+link+'[trenn]'+bildlink+'[trenn]'+name+'">'+kurzerlink+'</a>';
        }
        else {
        ...
        if (vorschaubuttonstatus.charAt(7)==1) { teiltext0ersatz = teiltext0ersatz+'<img src="'+imagespfad+'show.png" class="icons" onmouseover="src=\''+imagespfad+'show_d.png\';" onmouseout="src=\''+imagespfad+'show.png\'" onmousedown="swfarea(document.getElementById(\''+name+'div\'),this.alt)" title="Animation area Show/Hide" alt="'+link+'[trenn]'+name+'">'; }
