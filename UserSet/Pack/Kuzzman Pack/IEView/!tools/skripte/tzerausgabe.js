...
document.write('<img src="'+tzerbildpfad+'close.png" class="icons" onmouseover="src=\''+tzerbildpfad+'/close_d.png\';" onmouseout="src=\''+tzerbildpfad+'/close.png\';" style=\"height:16px; width:16px; position:absolute; visibility:hidden; z-index:30000;\" id="closeButton" onclick="ausblenden()" title="закрыть" alt="Закрыть">');
...
function tZersOutput (eingangsmeldung,chatpartner,tzersoderbild,zeigetzersname,bekommensenden) {
  ...
  if (checkTzer(link)) {
	...
	switch (tzersname.replace(/^\s+|\s+$/g,"")) {
	   case "guby":					tzersname = "Поцелуй";			break;
	   case "beer":					tzersname = "Пивка?;)";			break;
	   case "zadolbal":				tzersname = "Задолбал!";		break;
	   case "sobaka":				tzersname = "Хочу к тебе!";		break;
	   case "devochka":				tzersname = "Хны...!";			break;
	   case "bodun":				tzersname = "Отходняк...";		break;
	   case "serdze":				tzersname = "Сердце";			break;
	   case "smeh":					tzersname = "Жжёшь!";			break;
	   case "mad_dog":				tzersname = "А я сошла с ума...";	break;
	   case "rosy":					tzersname = "Миллион алых роз!";	break;
	   case "sobaka_strelyaet":			tzersname = "Пристрелю!";		break;
	   case "rabotaet":				tzersname = "Я занят";			break;
	   case "kot_cool":				tzersname = "Круто!";			break;
	   case "kot_goodbye":				tzersname = "Пока-пока";		break;
	   case "kot_spasibo":				tzersname = "Спасибо!";			break;
	   case "kot_nedutza":				tzersname = "Не дуться!";		break;
	   case "kot_obida":				tzersname = "Обидели";			break;
	   case "kot_wow":				tzersname = "Ух ты!";			break;
	   case "bad_cold":				tzersname = "Болею";			break;
	   case "information":				tzersname = "Взрыв мозга";		break;
	   case "joy":					tzersname = "Радость";			break;
	   case "krizis":				tzersname = "Голяк";			break;
	   case "missyou":				tzersname = "Скучаю";			break;
	   case "tank":					tzersname = "Прорвемся!";		break;

	   case "gangsta":	case 'gangsterSheep':	tzersname = "Гангстер";			break;
	   case "canthearu":	case 'cant_hear':	tzersname = "Не слышу!";		break;
	   case "skratch":	case 'scratch':		tzersname = "Коготки";			break;
	   case "boo":					tzersname = "Фууууу";			break;
	   case "kisses":				tzersname = "Поцелуи";			break;
	   case "chillout":	case 'rastamab':	tzersname = "Расслабься";		break;
	   case "akitaka":	case 'sappuko':		tzersname = "Харакири";			break;
	   case "laugh":				tzersname = "Умора";			break;
	   case "duh":		case 'dahh':		tzersname = "Типа да!";			break;
	   case "beback":	case 'beBack':		tzersname = "Скоро буду";		break;
	   case "likeu":	case 'iLikeU':		tzersname = "Ты мне нравишься";		break;
	   case "sorry":				tzersname = "Извини";			break;

	   case "drako_bolnoy":				tzersname = "Будь здоров!";		break;
	   case "drako_koster":				tzersname = "Обед";			break;
	   case "drako_love":				tzersname = "Думаю о тебе";		break;
	   case "drako_opyatnica":			tzersname = "Пятница";			break;
	   case "drako_snegyrka":			tzersname = "Люблю людей";		break;
	   case "drako_zombie":				tzersname = "Зомби";			break;
	   case "love_bear_hugs":			tzersname = "Обнимаю";			break;
	   case "love_bear_kiss":			tzersname = "Целую";			break;
	   case "love_bear_rose":			tzersname = "С любовью";		break;
	   case "angel":				tzersname = "Выбираю тебя";		break;
	   case "wf_love_sdaus":			tzersname = "Сдаюсь";			break;
	   case "wf_love_srazila":			tzersname = "Сражен наповал";		break;

	   case "gntm_icq_tZer_01_dubist":		tzersname = "Топмодель";		break;
	   case "gntm_icq_tZer_02_dusiehstaus":		tzersname = "Появление";		break;
	   case "gntm_icq_tZer_03_drama":		tzersname = "Драма";			break;
	   case "gntm_icq_tZer_04_competition":		tzersname = "Конкурс";			break;
	   case "santa":				tzersname = "Санта";			break;
	   default:										break;
	}
    ...
    if (zeigetzersname == 'yes') {
      ...
      if (bekommensenden == 'get') {
        document.write(chatpartner+' прислал/а Вам мульт <font class="tzerlink" onmouseout="this.className=\'tzerlink\'" onmouseover="this.className=\'tzerlink2\'" onclick="tzersabspielen(&quot;'+swflink+'&quot;)">'+tzersname+'</font>');
      }  
      else {
        document.write('Вы отправили мульт <font class="tzerlink" onmouseout="this.className=\'tzerlink\'" onmouseover="this.className=\'tzerlink2\'" onclick="tzersabspielen(&quot;'+swflink+'&quot;)">'+tzersname+'</font>');
      }
    }
