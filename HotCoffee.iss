...
Type: filesandordirs; Name: {app}\Dictionaries; Check: IsPortableSetupType and IsUpdate;
...
Type: filesandordirs; Name: {app}\Plugin Updates; Check: IsPortableSetupType and IsUpdate;
