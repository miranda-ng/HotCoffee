...
#define generatecheck 1                                                     ; only for developers: 0 - generate check off, 1 - generate check on
...
Type: files; Name: {app}\*.*; Check: IsPortableSetupType and IsUpdate;
...
Source: x86\Icons\Proto_Omegle.dll; DestDir: {app}\Icons; Flags: ignoreversion; Components: Protocols\Omegle; AfterInstall: AddDetails;
 ; Protocols\Sametime
Source: {#AppArch}\Plugins\Sametime.dll; DestDir: {app}\Plugins; Flags: ignoreversion; Components: Protocols\Sametime; AfterInstall: AddDetails;
Source: x86\Icons\Proto_Sametime.dll; DestDir: {app}\Icons; Flags: ignoreversion; Components: Protocols\Sametime; AfterInstall: AddDetails;
 ; Protocols\Skype
...
Source: x86\Icons\Proto_WebView.dll; DestDir: {app}\Icons; Flags: ignoreversion; Components: Protocols\Pseudo\WebView; AfterInstall: AddDetails;
...
#define DarkSkin \
  ...
  "IsStyleChecked('Skin_Diplomat_Dark') or " + \
  "IsStyleChecked('Skin_Glamour_Aqua_Dark') or " + \
  "IsStyleChecked('Skin_Glamour_Dark') or " + \
  "IsStyleChecked('Skin_GoldTime_Dark') or " + \
  ...
  "IsStyleChecked('Skin_Textolite_Gray_Dark') or " + \
  "IsStyleChecked('Skin_WinStyle_Classic_Dark') or " + \
  "IsStyleChecked('Skin_WinStyle_Dark')"

#define LightSkin \
  "IsStyleChecked('Skin_Default_Miranda') or " + \
  "IsStyleChecked('Skin_Current_Windows') or " + \
  "IsStyleChecked('Skin_Custom_Miranda') or " + \
  "IsStyleChecked('Skin_Custom_Miranda_Light') or " + \
  "IsStyleChecked('Skin_Diplomat_Light') or " + \
  "IsStyleChecked('Skin_Glamour_Aqua_Light') or " + \
  "IsStyleChecked('Skin_Glamour_Light') or " + \
  "IsStyleChecked('Skin_GoldTime_Light') or " + \
  ...
  "IsStyleChecked('Skin_Textolite_Gray_Light') or " + \
  "IsStyleChecked('Skin_WinStyle_Classic_Light') or " + \
...
#sub SetIniFile
#emit ' ; ' + CurrentIni
Filename: {#CurrentIni}; Section: Langpack; Key: Current; String: udefault; Languages: en;{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: Langpack; Key: Current; String: ulangpack_russian.txt; Languages: ru;{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackInfo; Key: "Name"; String: u{#AppName};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackInfo; Key: Version; String: u{#AppFullVer};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackInfo; Key: MirVer; String: u{#AppMirFullVer};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackInfo; Key: Contacts; String: g\r\ne-mail: {#AppContacts}\r\njid: hotcoffee@xmpp.ru;{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackInfo; Key: ReleaseDate; String: u{#GetDateTimeString("dd.mm.yyyy", "", "")};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackUpdater; Key: File_VersionURL; String: uhttps://miranda-ng.org/distr/packs/HotCoffee/.hotcoffee_{#AppArch}.ini;{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackUpdater; Key: File_1_CurrentVersion; String: u{#GetDateTimeString("yyyy.m.d", "", "")};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackUpdater; Key: File_30_CurrentVersion; String: u{#GetDateTimeString("yyyy.m.d", "", "")};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: PackUpdater; Key: File_35_CurrentVersion; String: u{#GetDateTimeString("yyyy.m.d", "", "")};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: CLUIFrames; Key: Height12; String: w{code:GetCLUIFrames|Height12};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: CLUIFrames; Key: TBVisile12; String: b{code:GetCLUIFrames|TBVisile12};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: CLUI; Key: EqualSections; String: b{code:GetCLUIFrames|EqualSections};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
Filename: {#CurrentIni}; Section: CLUI; Key: StatusBarProtosPerLine; String: b{code:GetCLUIFrames|StatusBarProtosPerLine};{#if CurrentIni == AutoexecUpdateIni} Check: IsUpdate;{#endif}
#endsub
...
#sub AddCustomThemeIni
 ; DialogFontSize write to custom theme.ini
...
Filename: {app}\Skins\{#theme[i]}.ini; Section: TabSRMM_Fonts; Key: Font16Size; String: b-21; Flags: uninsdeleteentry; Components: Resources\Themes\{#theme[i]}; Check: IsAdditionalSettingChecked('DialogFontSize,5');
 ; DialogFontSize write to custom theme.msf
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AddCheckBox(SettingsHelper('DialogStatusMessages'), '', 1, False, True, True, False, nil);
          AddCheckBox(SettingsHelper('Autoreply'), '', 1, False, True, True, False, nil);
